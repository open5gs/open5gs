...
/** 8.2.52 Start Time
 * 
 * The Start Time IE indicates the time at which the UP function started to collect the charging information. It shall be
 * encoded as shown in Figure 8.2.52-1.
 * 
...
/** 8.2.53 End Time 
 * The End Time IE indicates the time at which the UP function ended to collect the charging information. It shall be
 * encoded as shown in Figure 8.2.53-1.
 * 
 ...
 * 
 * The Time of First Packet IE indicates the time stamp for the first IP packet transmitted for a given usage report. It shall
 * be encoded as shown in Figure 8.2.46-1. 
 * 
 * The End Time field shall contain a UTC time. Octets 5 to 8 shall be encoded in the same format as the first four octets
 * of the 64-bit timestamp format as defined in clause 6 of IETF RFC 5905 [12]. 
 * 
 ...
 * 
 * The Time of Last Packet IE indicates the time stamp for the last IP packet transmitted for a given usage report. It shall 
 * be encoded as shown in Figure 8.2.47-1. 
 * 
 * The End Time field shall contain a UTC time. Octets 5 to 8 shall be encoded in the same format as the first four octets
 * of the 64-bit timestamp format as defined in clause 6 of IETF RFC 5905 [12]. 
 * 
 ...
 * - Bit 4 – TONOP: If this bit is set to "1", then the Total Number of Packets field shall be present, otherwise the
 *   Total Number of Packets field shall not be present.
 * - Bit 5 – ULNOP: If this bit is set to "1", then the Uplink Number of Packets field shall be present, otherwise the
 *   Uplink Number of Packets field shall not be present.
 * - Bit 6 – DLNOP: If this bit is set to "1", then the Downlink Number of Packets field shall be present, otherwise
 *   the Downlink Number of Packets field shall not be present.
