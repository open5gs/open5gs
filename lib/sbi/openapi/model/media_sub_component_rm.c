    ...
    )
{
    ...
    media_sub_component_rm_local_var->tscai_input_dl = tscai_input_dl;
...
void OpenAPI_media_sub_component_rm_free(OpenAPI_media_sub_component_rm_t *media_sub_component_rm)
{
    ...
    OpenAPI_tscai_input_container_free(media_sub_component_rm->tscai_input_dl);
    OpenAPI_tscai_input_container_free(media_sub_component_rm->tscai_input_ul);
...
cJSON *OpenAPI_media_sub_component_rm_convertToJSON(OpenAPI_media_sub_component_rm_t *media_sub_component_rm)
{
    ...
    if (media_sub_component_rm->tscai_input_dl) {
        cJSON *tscai_input_dl_local_JSON = OpenAPI_tscai_input_container_convertToJSON(media_sub_component_rm->tscai_input_dl);
        if (tscai_input_dl_local_JSON == NULL) {
            ogs_error("OpenAPI_media_sub_component_rm_convertToJSON() failed [tscai_input_dl]");
            goto end;
        }
    ...
    if (media_sub_component_rm->tscai_input_ul) {
        cJSON *tscai_input_ul_local_JSON = OpenAPI_tscai_input_container_convertToJSON(media_sub_component_rm->tscai_input_ul);
        if (tscai_input_ul_local_JSON == NULL) {
            ogs_error("OpenAPI_media_sub_component_rm_convertToJSON() failed [tscai_input_ul]");
            goto end;
        }
...
OpenAPI_media_sub_component_rm_t *OpenAPI_media_sub_component_rm_parseFromJSON(cJSON *media_sub_component_rmJSON)
{
    ...
    cJSON *tscai_input_dl = cJSON_GetObjectItemCaseSensitive(media_sub_component_rmJSON, "tscaiInputDl");
    ...
    cJSON *tscai_input_ul = cJSON_GetObjectItemCaseSensitive(media_sub_component_rmJSON, "tscaiInputUl");
