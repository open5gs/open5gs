...
)
{
    ...
    plmn_restriction_local_var->access_type_restrictions = access_type_restrictions;
...
void OpenAPI_plmn_restriction_free(OpenAPI_plmn_restriction_t *plmn_restriction)
{
    ...
    if (plmn_restriction->access_type_restrictions) {
        OpenAPI_list_free(plmn_restriction->access_type_restrictions);
        plmn_restriction->access_type_restrictions = NULL;
    }
...
cJSON *OpenAPI_plmn_restriction_convertToJSON(OpenAPI_plmn_restriction_t *plmn_restriction)
{
    ...
    if (plmn_restriction->access_type_restrictions != OpenAPI_access_type_NULL) {
    ...
    if (access_type_restrictionsList == NULL) {
        ogs_error("OpenAPI_plmn_restriction_convertToJSON() failed [access_type_restrictions]");
        goto end;
    }
    OpenAPI_list_for_each(plmn_restriction->access_type_restrictions, node) {
...
OpenAPI_plmn_restriction_t *OpenAPI_plmn_restriction_parseFromJSON(cJSON *plmn_restrictionJSON)
{
    ...
    access_type_restrictions = cJSON_GetObjectItemCaseSensitive(plmn_restrictionJSON, "accessTypeRestrictions");
    if (access_type_restrictions) {
        cJSON *access_type_restrictions_local = NULL;
        if (!cJSON_IsArray(access_type_restrictions)) {
            ogs_error("OpenAPI_plmn_restriction_parseFromJSON() failed [access_type_restrictions]");
            goto end;
        }
        ...
        if (access_type_restrictionsList->count == 0) {
            ogs_error("OpenAPI_plmn_restriction_parseFromJSON() failed: Expected access_type_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
