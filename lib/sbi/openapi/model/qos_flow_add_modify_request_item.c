    ...
    )
{
    ...
    if (!qos_flow_add_modify_request_item_local_var) {
        return NULL;
    }
...
cJSON *OpenAPI_qos_flow_add_modify_request_item_convertToJSON(OpenAPI_qos_flow_add_modify_request_item_t *qos_flow_add_modify_request_item)
{
    ...
    if (!qos_flow_add_modify_request_item->qfi) {
    ...
    if (qos_flow_add_modify_request_item->qos_rules) {
        if (cJSON_AddNumberToObject(item, "qosRules", qos_flow_add_modify_request_item->qos_rules) == NULL) {
    ...
    if (qos_flow_add_modify_request_item->qos_flow_description) {
        if (cJSON_AddNumberToObject(item, "qosFlowDescription", qos_flow_add_modify_request_item->qos_flow_description) == NULL) {
...
OpenAPI_qos_flow_add_modify_request_item_t *OpenAPI_qos_flow_add_modify_request_item_parseFromJSON(cJSON *qos_flow_add_modify_request_itemJSON)
{
    ...
    cJSON *qfi = cJSON_GetObjectItemCaseSensitive(qos_flow_add_modify_request_itemJSON, "qfi");
    if (!qfi) {
    ...
    cJSON *ebi = cJSON_GetObjectItemCaseSensitive(qos_flow_add_modify_request_itemJSON, "ebi");
    ...
    cJSON *qos_rules = cJSON_GetObjectItemCaseSensitive(qos_flow_add_modify_request_itemJSON, "qosRules");
    ...
    cJSON *qos_flow_description = cJSON_GetObjectItemCaseSensitive(qos_flow_add_modify_request_itemJSON, "qosFlowDescription");
    ...
    cJSON *qos_flow_profile = cJSON_GetObjectItemCaseSensitive(qos_flow_add_modify_request_itemJSON, "qosFlowProfile");
