...
{
    OpenAPI_inter_freq_target_info_t *inter_freq_target_info_local_var = OpenAPI_malloc(sizeof(OpenAPI_inter_freq_target_info_t));
    if (!inter_freq_target_info_local_var) {
        return NULL;
    }
