...
OpenAPI_reporting_access_type_t *OpenAPI_reporting_access_type_create(
)
{
...
void OpenAPI_reporting_access_type_free(OpenAPI_reporting_access_type_t *reporting_access_type)
{
    ...
    ogs_free(reporting_access_type);
}
...
{
    OpenAPI_reporting_access_type_t *reporting_access_type_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    reporting_access_type_local_var = OpenAPI_reporting_access_type_create (
    );
...
OpenAPI_reporting_access_type_t *OpenAPI_reporting_access_type_copy(OpenAPI_reporting_access_type_t *dst, OpenAPI_reporting_access_type_t *src)
{
    ...
    OpenAPI_reporting_access_type_free(dst);
    dst = OpenAPI_reporting_access_type_parseFromJSON(item);
    cJSON_Delete(item);
