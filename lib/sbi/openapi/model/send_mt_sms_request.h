/*
 * send_mt_sms_request.h
 *
 * 
 */

#ifndef _OpenAPI_send_mt_sms_request_H_
#define _OpenAPI_send_mt_sms_request_H_
...
typedef struct OpenAPI_send_mt_sms_request_s OpenAPI_send_mt_sms_request_t;
typedef struct OpenAPI_send_mt_sms_request_s {
    struct OpenAPI_sms_data_s *json_data;
    OpenAPI_binary_t* binary_payload;
} OpenAPI_send_mt_sms_request_t;
...
#endif /* _OpenAPI_send_mt_sms_request_H_ */
