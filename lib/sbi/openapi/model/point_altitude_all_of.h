...
#ifndef _OpenAPI_point_altitude_all_of_H_
#define _OpenAPI_point_altitude_all_of_H_
...
typedef struct OpenAPI_point_altitude_all_of_s OpenAPI_point_altitude_all_of_t;
typedef struct OpenAPI_point_altitude_all_of_s {
    struct OpenAPI_geographical_coordinates_s *point;
    double altitude;
} OpenAPI_point_altitude_all_of_t;
...
#endif /* _OpenAPI_point_altitude_all_of_H_ */
