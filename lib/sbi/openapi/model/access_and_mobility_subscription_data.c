...
)
{
    ...
    access_and_mobility_subscription_data_local_var->splmn_rat_usage_control = splmn_rat_usage_control;
    ...
    access_and_mobility_subscription_data_local_var->access_type_restrictions = access_type_restrictions;
    ...
    access_and_mobility_subscription_data_local_var->is_mps_msg_indication = is_mps_msg_indication;
    access_and_mobility_subscription_data_local_var->mps_msg_indication = mps_msg_indication;
    ...
    access_and_mobility_subscription_data_local_var->odb_exempted_dnn_data = odb_exempted_dnn_data;
    ...
    access_and_mobility_subscription_data_local_var->adjacent_plmn_mdt_user_consents = adjacent_plmn_mdt_user_consents;
    ...
    access_and_mobility_subscription_data_local_var->shared_trace_data_id = shared_trace_data_id;
    ...
    access_and_mobility_subscription_data_local_var->is_aun3_device_connectivity_allowed = is_aun3_device_connectivity_allowed;
    access_and_mobility_subscription_data_local_var->aun3_device_connectivity_allowed = aun3_device_connectivity_allowed;
    ...
    access_and_mobility_subscription_data_local_var->expected_ue_behaviour_data = expected_ue_behaviour_data;
    ...
    access_and_mobility_subscription_data_local_var->_3gpp_charging_characteristics = _3gpp_charging_characteristics;
    access_and_mobility_subscription_data_local_var->chf_group_id = chf_group_id;
    access_and_mobility_subscription_data_local_var->time_sync_data = time_sync_data;
    access_and_mobility_subscription_data_local_var->shared_data_list = shared_data_list;
    access_and_mobility_subscription_data_local_var->qmc_config_info = qmc_config_info;
    access_and_mobility_subscription_data_local_var->mbsr_operation_allowed = mbsr_operation_allowed;
    access_and_mobility_subscription_data_local_var->is_ncr_operation_allowed = is_ncr_operation_allowed;
    access_and_mobility_subscription_data_local_var->ncr_operation_allowed = ncr_operation_allowed;
    access_and_mobility_subscription_data_local_var->ladn_service_areas = ladn_service_areas;
    access_and_mobility_subscription_data_local_var->ue_level_measurements_configuration = ue_level_measurements_configuration;
    access_and_mobility_subscription_data_local_var->allowed_rats = allowed_rats;
    access_and_mobility_subscription_data_local_var->is_am_policy_ind = is_am_policy_ind;
    access_and_mobility_subscription_data_local_var->am_policy_ind = am_policy_ind;
    access_and_mobility_subscription_data_local_var->is_ue_policy_ind = is_ue_policy_ind;
    access_and_mobility_subscription_data_local_var->ue_policy_ind = ue_policy_ind;
    access_and_mobility_subscription_data_local_var->is_energy_saving_ind = is_energy_saving_ind;
    access_and_mobility_subscription_data_local_var->energy_saving_ind = energy_saving_ind;
...
void OpenAPI_access_and_mobility_subscription_data_free(OpenAPI_access_and_mobility_subscription_data_t *access_and_mobility_subscription_data)
{
    ...
    if (access_and_mobility_subscription_data->splmn_rat_usage_control) {
        OpenAPI_list_free(access_and_mobility_subscription_data->splmn_rat_usage_control);
        access_and_mobility_subscription_data->splmn_rat_usage_control = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->access_type_restrictions) {
        OpenAPI_list_free(access_and_mobility_subscription_data->access_type_restrictions);
        access_and_mobility_subscription_data->access_type_restrictions = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->odb_exempted_dnn_data) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->odb_exempted_dnn_data, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_odb_exempted_dnn_info_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(access_and_mobility_subscription_data->odb_exempted_dnn_data);
        access_and_mobility_subscription_data->odb_exempted_dnn_data = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->adjacent_plmn_mdt_user_consents) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->adjacent_plmn_mdt_user_consents, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(access_and_mobility_subscription_data->adjacent_plmn_mdt_user_consents);
        access_and_mobility_subscription_data->adjacent_plmn_mdt_user_consents = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->shared_trace_data_id) {
        ogs_free(access_and_mobility_subscription_data->shared_trace_data_id);
        access_and_mobility_subscription_data->shared_trace_data_id = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->expected_ue_behaviour_data) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->expected_ue_behaviour_data, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_expected_ue_behaviour_data_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(access_and_mobility_subscription_data->expected_ue_behaviour_data);
        access_and_mobility_subscription_data->expected_ue_behaviour_data = NULL;
    }
    ...
    if (access_and_mobility_subscription_data->_3gpp_charging_characteristics) {
        ogs_free(access_and_mobility_subscription_data->_3gpp_charging_characteristics);
        access_and_mobility_subscription_data->_3gpp_charging_characteristics = NULL;
    }
    if (access_and_mobility_subscription_data->chf_group_id) {
        ogs_free(access_and_mobility_subscription_data->chf_group_id);
        access_and_mobility_subscription_data->chf_group_id = NULL;
    }
    if (access_and_mobility_subscription_data->time_sync_data) {
        OpenAPI_time_sync_data_free(access_and_mobility_subscription_data->time_sync_data);
        access_and_mobility_subscription_data->time_sync_data = NULL;
    }
    if (access_and_mobility_subscription_data->shared_data_list) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->shared_data_list, node) {
            OpenAPI_shared_data_free(node->data);
        }
        OpenAPI_list_free(access_and_mobility_subscription_data->shared_data_list);
        access_and_mobility_subscription_data->shared_data_list = NULL;
    }
    if (access_and_mobility_subscription_data->qmc_config_info) {
        OpenAPI_qmc_config_info_free(access_and_mobility_subscription_data->qmc_config_info);
        access_and_mobility_subscription_data->qmc_config_info = NULL;
    }
    if (access_and_mobility_subscription_data->mbsr_operation_allowed) {
        OpenAPI_mbsr_operation_allowed_free(access_and_mobility_subscription_data->mbsr_operation_allowed);
        access_and_mobility_subscription_data->mbsr_operation_allowed = NULL;
    }
    if (access_and_mobility_subscription_data->ladn_service_areas) {
        OpenAPI_list_for_each(access_and_mobility_subscription_data->ladn_service_areas, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_dnn_ladn_service_areas_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(access_and_mobility_subscription_data->ladn_service_areas);
        access_and_mobility_subscription_data->ladn_service_areas = NULL;
    }
    if (access_and_mobility_subscription_data->ue_level_measurements_configuration) {
        OpenAPI_ue_level_measurements_configuration_free(access_and_mobility_subscription_data->ue_level_measurements_configuration);
        access_and_mobility_subscription_data->ue_level_measurements_configuration = NULL;
    }
    if (access_and_mobility_subscription_data->allowed_rats) {
        OpenAPI_list_free(access_and_mobility_subscription_data->allowed_rats);
        access_and_mobility_subscription_data->allowed_rats = NULL;
    }
...
cJSON *OpenAPI_access_and_mobility_subscription_data_convertToJSON(OpenAPI_access_and_mobility_subscription_data_t *access_and_mobility_subscription_data)
{
    ...
    if (access_and_mobility_subscription_data->splmn_rat_usage_control != OpenAPI_rat_type_NULL) {
    cJSON *splmn_rat_usage_controlList = cJSON_AddArrayToObject(item, "splmnRatUsageControl");
    if (splmn_rat_usage_controlList == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [splmn_rat_usage_control]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->splmn_rat_usage_control, node) {
    ...
    if (access_and_mobility_subscription_data->access_type_restrictions != OpenAPI_access_type_NULL) {
    ...
    if (access_type_restrictionsList == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [access_type_restrictions]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->access_type_restrictions, node) {
    ...
    if (access_and_mobility_subscription_data->is_mps_msg_indication) {
    if (cJSON_AddBoolToObject(item, "mpsMsgIndication", access_and_mobility_subscription_data->mps_msg_indication) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mps_msg_indication]");
        goto end;
    }
    }
    ...
    if (odb_exempted_dnn_data == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [odb_exempted_dnn_data]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->adjacent_plmn_mdt_user_consents != OpenAPI_mdt_user_consent_NULL) {
    ...
    if (adjacent_plmn_mdt_user_consents == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [adjacent_plmn_mdt_user_consents]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->shared_trace_data_id) {
    if (cJSON_AddStringToObject(item, "sharedTraceDataId", access_and_mobility_subscription_data->shared_trace_data_id) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [shared_trace_data_id]");
        goto end;
    }
    }
    ...
    if (access_and_mobility_subscription_data->is_aun3_device_connectivity_allowed) {
    if (cJSON_AddBoolToObject(item, "aun3DeviceConnectivityAllowed", access_and_mobility_subscription_data->aun3_device_connectivity_allowed) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [aun3_device_connectivity_allowed]");
        goto end;
    }
    }
    ...
    if (expected_ue_behaviour_data == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [expected_ue_behaviour_data]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->_3gpp_charging_characteristics) {
    if (cJSON_AddStringToObject(item, "3gppChargingCharacteristics", access_and_mobility_subscription_data->_3gpp_charging_characteristics) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [_3gpp_charging_characteristics]");
        goto end;
    }
    }

    if (access_and_mobility_subscription_data->chf_group_id) {
    if (cJSON_AddStringToObject(item, "chfGroupId", access_and_mobility_subscription_data->chf_group_id) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [chf_group_id]");
        goto end;
    }
    }

    if (access_and_mobility_subscription_data->time_sync_data) {
    cJSON *time_sync_data_local_JSON = OpenAPI_time_sync_data_convertToJSON(access_and_mobility_subscription_data->time_sync_data);
    if (time_sync_data_local_JSON == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [time_sync_data]");
        goto end;
    }
    ...
    if (shared_data_listList == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [shared_data_list]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->shared_data_list, node) {
    ...
    if (access_and_mobility_subscription_data->qmc_config_info) {
    cJSON *qmc_config_info_local_JSON = OpenAPI_qmc_config_info_convertToJSON(access_and_mobility_subscription_data->qmc_config_info);
    if (qmc_config_info_local_JSON == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [qmc_config_info]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->mbsr_operation_allowed) {
    cJSON *mbsr_operation_allowed_local_JSON = OpenAPI_mbsr_operation_allowed_convertToJSON(access_and_mobility_subscription_data->mbsr_operation_allowed);
    if (mbsr_operation_allowed_local_JSON == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [mbsr_operation_allowed]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->is_ncr_operation_allowed) {
    if (cJSON_AddBoolToObject(item, "ncrOperationAllowed", access_and_mobility_subscription_data->ncr_operation_allowed) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ncr_operation_allowed]");
        goto end;
    }
    }
    ...
    if (ladn_service_areas == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ladn_service_areas]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->ue_level_measurements_configuration) {
    cJSON *ue_level_measurements_configuration_local_JSON = OpenAPI_ue_level_measurements_configuration_convertToJSON(access_and_mobility_subscription_data->ue_level_measurements_configuration);
    if (ue_level_measurements_configuration_local_JSON == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ue_level_measurements_configuration]");
        goto end;
    }
    ...
    if (access_and_mobility_subscription_data->allowed_rats != OpenAPI_rat_type_NULL) {
    cJSON *allowed_ratsList = cJSON_AddArrayToObject(item, "allowedRATs");
    if (allowed_ratsList == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [allowed_rats]");
        goto end;
    }
    OpenAPI_list_for_each(access_and_mobility_subscription_data->allowed_rats, node) {
    ...
    if (cJSON_AddBoolToObject(item, "amPolicyInd", access_and_mobility_subscription_data->am_policy_ind) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [am_policy_ind]");
        goto end;
    }
    }

    if (access_and_mobility_subscription_data->is_ue_policy_ind) {
    if (cJSON_AddBoolToObject(item, "uePolicyInd", access_and_mobility_subscription_data->ue_policy_ind) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [ue_policy_ind]");
        goto end;
    }
    }

    if (access_and_mobility_subscription_data->is_energy_saving_ind) {
    if (cJSON_AddNumberToObject(item, "energySavingInd", access_and_mobility_subscription_data->energy_saving_ind) == NULL) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_convertToJSON() failed [energy_saving_ind]");
        goto end;
    }
    }
...
OpenAPI_access_and_mobility_subscription_data_t *OpenAPI_access_and_mobility_subscription_data_parseFromJSON(cJSON *access_and_mobility_subscription_dataJSON)
{
    ...
    OpenAPI_time_sync_data_t *time_sync_data_local_nonprim = NULL;
    cJSON *shared_data_list = NULL;
    OpenAPI_list_t *shared_data_listList = NULL;
    cJSON *qmc_config_info = NULL;
    OpenAPI_qmc_config_info_t *qmc_config_info_local_nonprim = NULL;
    cJSON *mbsr_operation_allowed = NULL;
    OpenAPI_mbsr_operation_allowed_t *mbsr_operation_allowed_local_nonprim = NULL;
    ...
    OpenAPI_ue_level_measurements_configuration_t *ue_level_measurements_configuration_local_nonprim = NULL;
    ...
    splmn_rat_usage_control = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "splmnRatUsageControl");
    if (splmn_rat_usage_control) {
        cJSON *splmn_rat_usage_control_local = NULL;
        if (!cJSON_IsArray(splmn_rat_usage_control)) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [splmn_rat_usage_control]");
            goto end;
        }
        ...
        if (splmn_rat_usage_controlList->count == 0) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected splmn_rat_usage_controlList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    access_type_restrictions = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "accessTypeRestrictions");
    if (access_type_restrictions) {
        cJSON *access_type_restrictions_local = NULL;
        if (!cJSON_IsArray(access_type_restrictions)) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [access_type_restrictions]");
            goto end;
        }
        ...
        if (access_type_restrictionsList->count == 0) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected access_type_restrictionsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    mps_msg_indication = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "mpsMsgIndication");
    if (mps_msg_indication) {
    if (!cJSON_IsBool(mps_msg_indication)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [mps_msg_indication]");
        goto end;
    }
    }
    ...
    odb_exempted_dnn_data = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "odbExemptedDnnData");
    ...
    adjacent_plmn_mdt_user_consents = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "adjacentPlmnMdtUserConsents");
    ...
    shared_trace_data_id = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "sharedTraceDataId");
    if (shared_trace_data_id) {
    if (!cJSON_IsString(shared_trace_data_id) && !cJSON_IsNull(shared_trace_data_id)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [shared_trace_data_id]");
        goto end;
    }
    }
    ...
    aun3_device_connectivity_allowed = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "aun3DeviceConnectivityAllowed");
    if (aun3_device_connectivity_allowed) {
    if (!cJSON_IsBool(aun3_device_connectivity_allowed)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [aun3_device_connectivity_allowed]");
        goto end;
    }
    }
    ...
    expected_ue_behaviour_data = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "expectedUeBehaviourData");
    ...
    _3gpp_charging_characteristics = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "3gppChargingCharacteristics");
    ...
    if (!cJSON_IsString(_3gpp_charging_characteristics) && !cJSON_IsNull(_3gpp_charging_characteristics)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [_3gpp_charging_characteristics]");
        goto end;
    }
    }

    chf_group_id = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "chfGroupId");
    if (chf_group_id) {
    if (!cJSON_IsString(chf_group_id) && !cJSON_IsNull(chf_group_id)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [chf_group_id]");
        goto end;
    }
    }

    time_sync_data = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "timeSyncData");
    if (time_sync_data) {
    time_sync_data_local_nonprim = OpenAPI_time_sync_data_parseFromJSON(time_sync_data);
    if (!time_sync_data_local_nonprim) {
        ogs_error("OpenAPI_time_sync_data_parseFromJSON failed [time_sync_data]");
        goto end;
    }
    }

    shared_data_list = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "sharedDataList");
    if (shared_data_list) {
        cJSON *shared_data_list_local = NULL;
        if (!cJSON_IsArray(shared_data_list)) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [shared_data_list]");
            goto end;
        }
    ...
    qmc_config_info = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "qmcConfigInfo");
    if (qmc_config_info) {
    qmc_config_info_local_nonprim = OpenAPI_qmc_config_info_parseFromJSON(qmc_config_info);
    if (!qmc_config_info_local_nonprim) {
        ogs_error("OpenAPI_qmc_config_info_parseFromJSON failed [qmc_config_info]");
        goto end;
    }
    }

    mbsr_operation_allowed = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "mbsrOperationAllowed");
    if (mbsr_operation_allowed) {
    mbsr_operation_allowed_local_nonprim = OpenAPI_mbsr_operation_allowed_parseFromJSON(mbsr_operation_allowed);
    if (!mbsr_operation_allowed_local_nonprim) {
        ogs_error("OpenAPI_mbsr_operation_allowed_parseFromJSON failed [mbsr_operation_allowed]");
        goto end;
    }
    }

    ncr_operation_allowed = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "ncrOperationAllowed");
    if (ncr_operation_allowed) {
    if (!cJSON_IsBool(ncr_operation_allowed)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [ncr_operation_allowed]");
        goto end;
    }
    }

    ladn_service_areas = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "ladnServiceAreas");
    ...
    ue_level_measurements_configuration = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "ueLevelMeasurementsConfiguration");
    if (ue_level_measurements_configuration) {
    ue_level_measurements_configuration_local_nonprim = OpenAPI_ue_level_measurements_configuration_parseFromJSON(ue_level_measurements_configuration);
    if (!ue_level_measurements_configuration_local_nonprim) {
        ogs_error("OpenAPI_ue_level_measurements_configuration_parseFromJSON failed [ue_level_measurements_configuration]");
        goto end;
    }
    }

    allowed_rats = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "allowedRATs");
    if (allowed_rats) {
        cJSON *allowed_rats_local = NULL;
        if (!cJSON_IsArray(allowed_rats)) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [allowed_rats]");
            goto end;
        }
        ...
        if (allowed_ratsList->count == 0) {
            ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed: Expected allowed_ratsList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }

    am_policy_ind = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "amPolicyInd");
    if (am_policy_ind) {
    if (!cJSON_IsBool(am_policy_ind)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [am_policy_ind]");
        goto end;
    }
    }

    ue_policy_ind = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "uePolicyInd");
    if (ue_policy_ind) {
    if (!cJSON_IsBool(ue_policy_ind)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [ue_policy_ind]");
        goto end;
    }
    }

    energy_saving_ind = cJSON_GetObjectItemCaseSensitive(access_and_mobility_subscription_dataJSON, "energySavingInd");
    if (energy_saving_ind) {
    if (!cJSON_IsNumber(energy_saving_ind)) {
        ogs_error("OpenAPI_access_and_mobility_subscription_data_parseFromJSON() failed [energy_saving_ind]");
        goto end;
    }
    }
    ...
    if (time_sync_data_local_nonprim) {
        OpenAPI_time_sync_data_free(time_sync_data_local_nonprim);
    ...
    if (qmc_config_info_local_nonprim) {
        OpenAPI_qmc_config_info_free(qmc_config_info_local_nonprim);
        qmc_config_info_local_nonprim = NULL;
    }
    if (mbsr_operation_allowed_local_nonprim) {
        OpenAPI_mbsr_operation_allowed_free(mbsr_operation_allowed_local_nonprim);
    ...
    if (ue_level_measurements_configuration_local_nonprim) {
        OpenAPI_ue_level_measurements_configuration_free(ue_level_measurements_configuration_local_nonprim);
