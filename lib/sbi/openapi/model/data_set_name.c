...
{
    const char *data_set_nameArray[] =  { "NULL", "AM", "SMF_SEL", "UEC_SMF", "UEC_SMSF", "SMS_SUB", "SM", "TRACE", "SMS_MNG", "LCS_PRIVACY", "LCS_MO", "LCS_SUB", "UEC_AMF", "V2X", "LCS_BCA", "PROSE", "UC", "MBS", "A2X", "RANGINGSL_PRIVACY" };
