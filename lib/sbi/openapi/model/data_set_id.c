...
{
    const char *data_set_idArray[] =  { "NULL", "SUBSCRIPTION", "POLICY", "EXPOSURE", "APPLICATION", "A_PFD", "A_AFTI", "A_AFQOS", "A_IPTV", "A_BDT", "A_SPD", "A_EASD", "A_EACI", "A_AMI", "A_DEM", "A_ALIM", "P_UE", "P_SCD", "P_BDT", "P_PLMNUE", "P_NSSCD", "P_PDTQ", "P_MBSCD", "P_GROUP", "AIOT" };
