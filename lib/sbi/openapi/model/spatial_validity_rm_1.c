...
{
    OpenAPI_spatial_validity_rm_1_t *spatial_validity_rm_1_local_var = ogs_malloc(sizeof(OpenAPI_spatial_validity_rm_1_t));
    ogs_assert(spatial_validity_rm_1_local_var);

    spatial_validity_rm_1_local_var->presence_info_list = presence_info_list;

    return spatial_validity_rm_1_local_var;
}
...
void OpenAPI_spatial_validity_rm_1_free(OpenAPI_spatial_validity_rm_1_t *spatial_validity_rm_1)
{
    ...
    if (NULL == spatial_validity_rm_1) {
        return;
    }
    if (spatial_validity_rm_1->presence_info_list) {
        OpenAPI_list_for_each(spatial_validity_rm_1->presence_info_list, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_presence_info_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(spatial_validity_rm_1->presence_info_list);
        spatial_validity_rm_1->presence_info_list = NULL;
    }
    ogs_free(spatial_validity_rm_1);
}
...
cJSON *OpenAPI_spatial_validity_rm_1_convertToJSON(OpenAPI_spatial_validity_rm_1_t *spatial_validity_rm_1)
{
    ...
    if (spatial_validity_rm_1 == NULL) {
        ogs_error("OpenAPI_spatial_validity_rm_1_convertToJSON() failed [SpatialValidityRm_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!spatial_validity_rm_1->presence_info_list) {
        ogs_error("OpenAPI_spatial_validity_rm_1_convertToJSON() failed [presence_info_list]");
        return NULL;
    }
    ...
    if (spatial_validity_rm_1->presence_info_list) {
        OpenAPI_list_for_each(spatial_validity_rm_1->presence_info_list, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_spatial_validity_rm_1_convertToJSON() failed [inner]");
                goto end;
            }
...
{
    OpenAPI_spatial_validity_rm_1_t *spatial_validity_rm_1_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    cJSON *presence_info_list = NULL;
    OpenAPI_list_t *presence_info_listList = NULL;
    presence_info_list = cJSON_GetObjectItemCaseSensitive(spatial_validity_rm_1JSON, "presenceInfoList");
    ...
    spatial_validity_rm_1_local_var = OpenAPI_spatial_validity_rm_1_create (
...
OpenAPI_spatial_validity_rm_1_t *OpenAPI_spatial_validity_rm_1_copy(OpenAPI_spatial_validity_rm_1_t *dst, OpenAPI_spatial_validity_rm_1_t *src)
{
    ...
    ogs_assert(src);
    item = OpenAPI_spatial_validity_rm_1_convertToJSON(src);
    if (!item) {
        ogs_error("OpenAPI_spatial_validity_rm_1_convertToJSON() failed");
        return NULL;
    }
    ...
    OpenAPI_spatial_validity_rm_1_free(dst);
    dst = OpenAPI_spatial_validity_rm_1_parseFromJSON(item);
    cJSON_Delete(item);
