...
{
    OpenAPI_red_trans_exp_ordering_criterion_t *red_trans_exp_ordering_criterion_local_var = ogs_malloc(sizeof(OpenAPI_red_trans_exp_ordering_criterion_t));
    ogs_assert(red_trans_exp_ordering_criterion_local_var);
...
void OpenAPI_red_trans_exp_ordering_criterion_free(OpenAPI_red_trans_exp_ordering_criterion_t *red_trans_exp_ordering_criterion)
{
    ...
    ogs_free(red_trans_exp_ordering_criterion);
}
...
cJSON *OpenAPI_red_trans_exp_ordering_criterion_convertToJSON(OpenAPI_red_trans_exp_ordering_criterion_t *red_trans_exp_ordering_criterion)
{
    ...
    if (red_trans_exp_ordering_criterion == NULL) {
        ogs_error("OpenAPI_red_trans_exp_ordering_criterion_convertToJSON() failed [RedTransExpOrderingCriterion]");
        return NULL;
    }
...
{
    OpenAPI_red_trans_exp_ordering_criterion_t *red_trans_exp_ordering_criterion_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    red_trans_exp_ordering_criterion_local_var = OpenAPI_red_trans_exp_ordering_criterion_create (
    );
...
OpenAPI_red_trans_exp_ordering_criterion_t *OpenAPI_red_trans_exp_ordering_criterion_copy(OpenAPI_red_trans_exp_ordering_criterion_t *dst, OpenAPI_red_trans_exp_ordering_criterion_t *src)
{
    ...
    ogs_assert(src);
    item = OpenAPI_red_trans_exp_ordering_criterion_convertToJSON(src);
    if (!item) {
        ogs_error("OpenAPI_red_trans_exp_ordering_criterion_convertToJSON() failed");
        return NULL;
    }
    ...
    OpenAPI_red_trans_exp_ordering_criterion_free(dst);
    dst = OpenAPI_red_trans_exp_ordering_criterion_parseFromJSON(item);
    cJSON_Delete(item);
