...
cJSON *OpenAPI_reachability_for_data_configuration_1_convertToJSON(OpenAPI_reachability_for_data_configuration_1_t *reachability_for_data_configuration_1)
{
    ...
    if (reachability_for_data_configuration_1->report_cfg == OpenAPI_reachability_for_data_report_config_NULL) {
        ogs_error("OpenAPI_reachability_for_data_configuration_1_convertToJSON() failed [report_cfg]");
        return NULL;
    }
    if (cJSON_AddStringToObject(item, "reportCfg", OpenAPI_reachability_for_data_report_config_ToString(reachability_for_data_configuration_1->report_cfg)) == NULL) {
        ogs_error("OpenAPI_reachability_for_data_configuration_1_convertToJSON() failed [report_cfg]");
        goto end;
    }
