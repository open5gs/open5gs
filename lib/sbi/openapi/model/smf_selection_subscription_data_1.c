...
)
{
    ...
    smf_selection_subscription_data_1_local_var->additional_shared_snssai_infos_ids = additional_shared_snssai_infos_ids;
...
void OpenAPI_smf_selection_subscription_data_1_free(OpenAPI_smf_selection_subscription_data_1_t *smf_selection_subscription_data_1)
{
    ...
    if (smf_selection_subscription_data_1->additional_shared_snssai_infos_ids) {
        OpenAPI_list_for_each(smf_selection_subscription_data_1->additional_shared_snssai_infos_ids, node) {
            ogs_free(node->data);
        }
        OpenAPI_list_free(smf_selection_subscription_data_1->additional_shared_snssai_infos_ids);
        smf_selection_subscription_data_1->additional_shared_snssai_infos_ids = NULL;
    }
...
cJSON *OpenAPI_smf_selection_subscription_data_1_convertToJSON(OpenAPI_smf_selection_subscription_data_1_t *smf_selection_subscription_data_1)
{
    ...
    if (additional_shared_snssai_infos_idsList == NULL) {
        ogs_error("OpenAPI_smf_selection_subscription_data_1_convertToJSON() failed [additional_shared_snssai_infos_ids]");
        goto end;
    }
    OpenAPI_list_for_each(smf_selection_subscription_data_1->additional_shared_snssai_infos_ids, node) {
...
OpenAPI_smf_selection_subscription_data_1_t *OpenAPI_smf_selection_subscription_data_1_parseFromJSON(cJSON *smf_selection_subscription_data_1JSON)
{
    ...
    additional_shared_snssai_infos_ids = cJSON_GetObjectItemCaseSensitive(smf_selection_subscription_data_1JSON, "additionalSharedSnssaiInfosIds");
    if (additional_shared_snssai_infos_ids) {
        ...
        if (!cJSON_IsArray(additional_shared_snssai_infos_ids)) {
            ogs_error("OpenAPI_smf_selection_subscription_data_1_parseFromJSON() failed [additional_shared_snssai_infos_ids]");
            goto end;
        }
