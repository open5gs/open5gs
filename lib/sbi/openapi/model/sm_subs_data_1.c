...
cJSON *OpenAPI_sm_subs_data_1_convertToJSON(OpenAPI_sm_subs_data_1_t *sm_subs_data_1)
{
    ...
    if (sm_subs_data_1->extended_sm_subs_data) {
    cJSON *extended_sm_subs_data_local_JSON = OpenAPI_extended_sm_subs_data_convertToJSON(sm_subs_data_1->extended_sm_subs_data);
    if (extended_sm_subs_data_local_JSON == NULL) {
        ogs_error("OpenAPI_sm_subs_data_1_convertToJSON() failed [extended_sm_subs_data]");
        goto end;
    }
...
{
    OpenAPI_sm_subs_data_1_t *sm_subs_data_1_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    ...
    session_management_subscription_data_list = cJSON_GetObjectItemCaseSensitive(sm_subs_data_1JSON, "SessionManagementSubscriptionDataList");
    ...
    extended_sm_subs_data = cJSON_GetObjectItemCaseSensitive(sm_subs_data_1JSON, "ExtendedSmSubsData");
    ...
    sm_subs_data_1_local_var = OpenAPI_sm_subs_data_1_create (
