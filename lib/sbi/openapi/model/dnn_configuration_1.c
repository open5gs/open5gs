...
)
{
    ...
    dnn_configuration_1_local_var->is_uav_secondary_auth = is_uav_secondary_auth;
    dnn_configuration_1_local_var->uav_secondary_auth = uav_secondary_auth;
    ...
    dnn_configuration_1_local_var->additional_dn_aaa_addresses = additional_dn_aaa_addresses;
    dnn_configuration_1_local_var->dn_aaa_fqdn = dn_aaa_fqdn;
    ...
    dnn_configuration_1_local_var->additional_shared_ecs_addr_config_info_ids = additional_shared_ecs_addr_config_info_ids;
    dnn_configuration_1_local_var->is_eas_discovery_authorized = is_eas_discovery_authorized;
    dnn_configuration_1_local_var->eas_discovery_authorized = eas_discovery_authorized;
    dnn_configuration_1_local_var->is_onboarding_ind = is_onboarding_ind;
    dnn_configuration_1_local_var->onboarding_ind = onboarding_ind;
    dnn_configuration_1_local_var->aerial_ue_ind = aerial_ue_ind;
    dnn_configuration_1_local_var->is_subscribed_max_ipv6_prefix_size = is_subscribed_max_ipv6_prefix_size;
    dnn_configuration_1_local_var->subscribed_max_ipv6_prefix_size = subscribed_max_ipv6_prefix_size;
    dnn_configuration_1_local_var->is_hr_sbo_authorized = is_hr_sbo_authorized;
    dnn_configuration_1_local_var->hr_sbo_authorized = hr_sbo_authorized;
    dnn_configuration_1_local_var->required_upf_function_list = required_upf_function_list;
    dnn_configuration_1_local_var->pref_upf_function_list = pref_upf_function_list;
    dnn_configuration_1_local_var->vlan_tag_allowed = vlan_tag_allowed;
    dnn_configuration_1_local_var->vlan_tag_handling_info = vlan_tag_handling_info;
    dnn_configuration_1_local_var->is_local_offloading_mngt_ind = is_local_offloading_mngt_ind;
    dnn_configuration_1_local_var->local_offloading_mngt_ind = local_offloading_mngt_ind;
...
void OpenAPI_dnn_configuration_1_free(OpenAPI_dnn_configuration_1_t *dnn_configuration_1)
{
    ...
    if (dnn_configuration_1->additional_dn_aaa_addresses) {
        OpenAPI_list_for_each(dnn_configuration_1->additional_dn_aaa_addresses, node) {
            OpenAPI_ip_address_1_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->additional_dn_aaa_addresses);
        dnn_configuration_1->additional_dn_aaa_addresses = NULL;
    }
    if (dnn_configuration_1->dn_aaa_fqdn) {
        ogs_free(dnn_configuration_1->dn_aaa_fqdn);
        dnn_configuration_1->dn_aaa_fqdn = NULL;
    }
    ...
    if (dnn_configuration_1->ipv4_index) {
        OpenAPI_ip_index_free(dnn_configuration_1->ipv4_index);
        dnn_configuration_1->ipv4_index = NULL;
    }
    if (dnn_configuration_1->ipv6_index) {
        OpenAPI_ip_index_free(dnn_configuration_1->ipv6_index);
        dnn_configuration_1->ipv6_index = NULL;
    }
    if (dnn_configuration_1->ecs_addr_config_info) {
        OpenAPI_ecs_addr_config_info_1_free(dnn_configuration_1->ecs_addr_config_info);
        dnn_configuration_1->ecs_addr_config_info = NULL;
    }
    if (dnn_configuration_1->additional_ecs_addr_config_infos) {
        OpenAPI_list_for_each(dnn_configuration_1->additional_ecs_addr_config_infos, node) {
            OpenAPI_ecs_addr_config_info_1_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->additional_ecs_addr_config_infos);
        dnn_configuration_1->additional_ecs_addr_config_infos = NULL;
    }
    if (dnn_configuration_1->shared_ecs_addr_config_info) {
        ogs_free(dnn_configuration_1->shared_ecs_addr_config_info);
        dnn_configuration_1->shared_ecs_addr_config_info = NULL;
    }
    if (dnn_configuration_1->additional_shared_ecs_addr_config_info_ids) {
        OpenAPI_list_for_each(dnn_configuration_1->additional_shared_ecs_addr_config_info_ids, node) {
            ogs_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->additional_shared_ecs_addr_config_info_ids);
        dnn_configuration_1->additional_shared_ecs_addr_config_info_ids = NULL;
    }
    if (dnn_configuration_1->required_upf_function_list) {
        OpenAPI_list_for_each(dnn_configuration_1->required_upf_function_list, node) {
            OpenAPI_upf_functionality_data_1_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->required_upf_function_list);
        dnn_configuration_1->required_upf_function_list = NULL;
    }
    if (dnn_configuration_1->pref_upf_function_list) {
        OpenAPI_list_for_each(dnn_configuration_1->pref_upf_function_list, node) {
            OpenAPI_upf_functionality_data_with_priority_1_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->pref_upf_function_list);
        dnn_configuration_1->pref_upf_function_list = NULL;
    }
    if (dnn_configuration_1->vlan_tag_allowed) {
        OpenAPI_list_for_each(dnn_configuration_1->vlan_tag_allowed, node) {
            OpenAPI_vlan_tag_value_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->vlan_tag_allowed);
        dnn_configuration_1->vlan_tag_allowed = NULL;
    }
    if (dnn_configuration_1->vlan_tag_handling_info) {
        OpenAPI_list_for_each(dnn_configuration_1->vlan_tag_handling_info, node) {
            OpenAPI_vlan_tag_handling_1_free(node->data);
        }
        OpenAPI_list_free(dnn_configuration_1->vlan_tag_handling_info);
        dnn_configuration_1->vlan_tag_handling_info = NULL;
    }
...
cJSON *OpenAPI_dnn_configuration_1_convertToJSON(OpenAPI_dnn_configuration_1_t *dnn_configuration_1)
{
    ...
    OpenAPI_list_for_each(dnn_configuration_1->ipv4_frame_route_list, node) {
        cJSON *itemLocal = OpenAPI_frame_route_info_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [ipv4_frame_route_list]");
            goto end;
        }
    ...
    if (dnn_configuration_1->is_uav_secondary_auth) {
    if (cJSON_AddBoolToObject(item, "uavSecondaryAuth", dnn_configuration_1->uav_secondary_auth) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [uav_secondary_auth]");
        goto end;
    }
    }
    ...
    if (additional_dn_aaa_addressesList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [additional_dn_aaa_addresses]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->additional_dn_aaa_addresses, node) {
        cJSON *itemLocal = OpenAPI_ip_address_1_convertToJSON(node->data);
    ...
    if (dnn_configuration_1->dn_aaa_fqdn) {
    if (cJSON_AddStringToObject(item, "dnAaaFqdn", dnn_configuration_1->dn_aaa_fqdn) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [dn_aaa_fqdn]");
        goto end;
    }
    }
    ...
    if (ipv4_index_local_JSON == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [ipv4_index]");
        goto end;
    }
    ...
    if (ipv6_index_local_JSON == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [ipv6_index]");
        goto end;
    }
    ...
    if (dnn_configuration_1->ecs_addr_config_info) {
    cJSON *ecs_addr_config_info_local_JSON = OpenAPI_ecs_addr_config_info_1_convertToJSON(dnn_configuration_1->ecs_addr_config_info);
    ...
    if (additional_ecs_addr_config_infosList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [additional_ecs_addr_config_infos]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->additional_ecs_addr_config_infos, node) {
    ...
    if (dnn_configuration_1->shared_ecs_addr_config_info) {
    if (cJSON_AddStringToObject(item, "sharedEcsAddrConfigInfo", dnn_configuration_1->shared_ecs_addr_config_info) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [shared_ecs_addr_config_info]");
        goto end;
    }
    }
    ...
    if (additional_shared_ecs_addr_config_info_idsList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [additional_shared_ecs_addr_config_info_ids]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->additional_shared_ecs_addr_config_info_ids, node) {
    ...
    if (dnn_configuration_1->is_eas_discovery_authorized) {
    if (cJSON_AddBoolToObject(item, "easDiscoveryAuthorized", dnn_configuration_1->eas_discovery_authorized) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [eas_discovery_authorized]");
        goto end;
    }
    }

    if (dnn_configuration_1->is_onboarding_ind) {
    if (cJSON_AddBoolToObject(item, "onboardingInd", dnn_configuration_1->onboarding_ind) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [onboarding_ind]");
        goto end;
    }
    }

    if (dnn_configuration_1->aerial_ue_ind != OpenAPI_aerial_ue_indication_NULL) {
    if (cJSON_AddStringToObject(item, "aerialUeInd", OpenAPI_aerial_ue_indication_ToString(dnn_configuration_1->aerial_ue_ind)) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [aerial_ue_ind]");
        goto end;
    }
    }

    if (dnn_configuration_1->is_subscribed_max_ipv6_prefix_size) {
    if (cJSON_AddNumberToObject(item, "subscribedMaxIpv6PrefixSize", dnn_configuration_1->subscribed_max_ipv6_prefix_size) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [subscribed_max_ipv6_prefix_size]");
        goto end;
    }
    }

    if (dnn_configuration_1->is_hr_sbo_authorized) {
    if (cJSON_AddBoolToObject(item, "hrSboAuthorized", dnn_configuration_1->hr_sbo_authorized) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [hr_sbo_authorized]");
        goto end;
    }
    }
    ...
    if (required_upf_function_listList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [required_upf_function_list]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->required_upf_function_list, node) {
        cJSON *itemLocal = OpenAPI_upf_functionality_data_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [required_upf_function_list]");
            goto end;
        }
    ...
    if (pref_upf_function_listList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [pref_upf_function_list]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->pref_upf_function_list, node) {
        cJSON *itemLocal = OpenAPI_upf_functionality_data_with_priority_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [pref_upf_function_list]");
            goto end;
        }
    ...
    if (vlan_tag_allowedList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [vlan_tag_allowed]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->vlan_tag_allowed, node) {
    ...
    if (vlan_tag_handling_infoList == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [vlan_tag_handling_info]");
        goto end;
    }
    OpenAPI_list_for_each(dnn_configuration_1->vlan_tag_handling_info, node) {
        cJSON *itemLocal = OpenAPI_vlan_tag_handling_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [vlan_tag_handling_info]");
            goto end;
        }
    ...
    if (dnn_configuration_1->is_local_offloading_mngt_ind) {
    if (cJSON_AddBoolToObject(item, "localOffloadingMngtInd", dnn_configuration_1->local_offloading_mngt_ind) == NULL) {
        ogs_error("OpenAPI_dnn_configuration_1_convertToJSON() failed [local_offloading_mngt_ind]");
        goto end;
    }
    }
...
OpenAPI_dnn_configuration_1_t *OpenAPI_dnn_configuration_1_parseFromJSON(cJSON *dnn_configuration_1JSON)
{
    ...
    if (!ssc_modes_local_nonprim) {
        ogs_error("OpenAPI_ssc_modes_1_parseFromJSON failed [ssc_modes]");
        goto end;
    }
    ...
    if (!_5g_qos_profile_local_nonprim) {
        ogs_error("OpenAPI_subscribed_default_qos_1_parseFromJSON failed [_5g_qos_profile]");
        goto end;
    }
    }
    ...
    if (!session_ambr_local_nonprim) {
        ogs_error("OpenAPI_ambr_1_parseFromJSON failed [session_ambr]");
        goto end;
    }
    }
    ...
    if (!nidd_info_local_nonprim) {
        ogs_error("OpenAPI_nidd_information_1_parseFromJSON failed [nidd_info]");
        goto end;
    }
    }
    ...
    if (!acs_info_local_nonprim) {
        ogs_error("OpenAPI_acs_info_1_parseFromJSON failed [acs_info]");
        goto end;
    }
    }
    ...
    if (ipv4_frame_route_list) {
        ...
        cJSON_ArrayForEach(ipv4_frame_route_list_local, ipv4_frame_route_list) {
            ...
            OpenAPI_frame_route_info_1_t *ipv4_frame_route_listItem = OpenAPI_frame_route_info_1_parseFromJSON(ipv4_frame_route_list_local);
    ...
    if (ipv6_frame_route_list) {
        ...
        cJSON_ArrayForEach(ipv6_frame_route_list_local, ipv6_frame_route_list) {
            ...
            OpenAPI_frame_route_info_1_t *ipv6_frame_route_listItem = OpenAPI_frame_route_info_1_parseFromJSON(ipv6_frame_route_list_local);
    ...
    uav_secondary_auth = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "uavSecondaryAuth");
    if (uav_secondary_auth) {
    if (!cJSON_IsBool(uav_secondary_auth)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [uav_secondary_auth]");
        goto end;
    }
    }
    ...
    additional_dn_aaa_addresses = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "additionalDnAaaAddresses");
    if (additional_dn_aaa_addresses) {
        cJSON *additional_dn_aaa_addresses_local = NULL;
        if (!cJSON_IsArray(additional_dn_aaa_addresses)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [additional_dn_aaa_addresses]");
            goto end;
        }
    ...
    dn_aaa_fqdn = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "dnAaaFqdn");
    if (dn_aaa_fqdn) {
    if (!cJSON_IsString(dn_aaa_fqdn) && !cJSON_IsNull(dn_aaa_fqdn)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [dn_aaa_fqdn]");
        goto end;
    }
    }
    ...
    ipv4_index = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "ipv4Index");
    if (ipv4_index) {
    ...
    ipv6_index = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "ipv6Index");
    if (ipv6_index) {
    ...
    if (additional_ecs_addr_config_infos) {
        ...
        if (!cJSON_IsArray(additional_ecs_addr_config_infos)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [additional_ecs_addr_config_infos]");
            goto end;
        }
    ...
    shared_ecs_addr_config_info = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "sharedEcsAddrConfigInfo");
    if (shared_ecs_addr_config_info) {
    if (!cJSON_IsString(shared_ecs_addr_config_info) && !cJSON_IsNull(shared_ecs_addr_config_info)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [shared_ecs_addr_config_info]");
        goto end;
    }
    }

    additional_shared_ecs_addr_config_info_ids = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "additionalSharedEcsAddrConfigInfoIds");
    if (additional_shared_ecs_addr_config_info_ids) {
        ...
        if (!cJSON_IsArray(additional_shared_ecs_addr_config_info_ids)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [additional_shared_ecs_addr_config_info_ids]");
            goto end;
        }
    ...
    eas_discovery_authorized = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "easDiscoveryAuthorized");
    if (eas_discovery_authorized) {
    if (!cJSON_IsBool(eas_discovery_authorized)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [eas_discovery_authorized]");
        goto end;
    }
    }

    onboarding_ind = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "onboardingInd");
    if (onboarding_ind) {
    if (!cJSON_IsBool(onboarding_ind)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [onboarding_ind]");
        goto end;
    }
    }

    aerial_ue_ind = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "aerialUeInd");
    if (aerial_ue_ind) {
    if (!cJSON_IsString(aerial_ue_ind)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [aerial_ue_ind]");
        goto end;
    }
    aerial_ue_indVariable = OpenAPI_aerial_ue_indication_FromString(aerial_ue_ind->valuestring);
    }

    subscribed_max_ipv6_prefix_size = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "subscribedMaxIpv6PrefixSize");
    if (subscribed_max_ipv6_prefix_size) {
    if (!cJSON_IsNumber(subscribed_max_ipv6_prefix_size)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [subscribed_max_ipv6_prefix_size]");
        goto end;
    }
    }

    hr_sbo_authorized = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "hrSboAuthorized");
    if (hr_sbo_authorized) {
    if (!cJSON_IsBool(hr_sbo_authorized)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [hr_sbo_authorized]");
        goto end;
    }
    }

    required_upf_function_list = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "requiredUpfFunctionList");
    if (required_upf_function_list) {
        cJSON *required_upf_function_list_local = NULL;
        if (!cJSON_IsArray(required_upf_function_list)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [required_upf_function_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(required_upf_function_list_local, required_upf_function_list) {
            ...
            OpenAPI_upf_functionality_data_1_t *required_upf_function_listItem = OpenAPI_upf_functionality_data_1_parseFromJSON(required_upf_function_list_local);
    ...
    pref_upf_function_list = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "prefUpfFunctionList");
    if (pref_upf_function_list) {
        cJSON *pref_upf_function_list_local = NULL;
        if (!cJSON_IsArray(pref_upf_function_list)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [pref_upf_function_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(pref_upf_function_list_local, pref_upf_function_list) {
            ...
            OpenAPI_upf_functionality_data_with_priority_1_t *pref_upf_function_listItem = OpenAPI_upf_functionality_data_with_priority_1_parseFromJSON(pref_upf_function_list_local);
    ...
    vlan_tag_allowed = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "vlanTagAllowed");
    if (vlan_tag_allowed) {
        cJSON *vlan_tag_allowed_local = NULL;
        if (!cJSON_IsArray(vlan_tag_allowed)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [vlan_tag_allowed]");
            goto end;
        }
    ...
    vlan_tag_handling_info = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "vlanTagHandlingInfo");
    if (vlan_tag_handling_info) {
        cJSON *vlan_tag_handling_info_local = NULL;
        if (!cJSON_IsArray(vlan_tag_handling_info)) {
            ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [vlan_tag_handling_info]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(vlan_tag_handling_info_local, vlan_tag_handling_info) {
            ...
            OpenAPI_vlan_tag_handling_1_t *vlan_tag_handling_infoItem = OpenAPI_vlan_tag_handling_1_parseFromJSON(vlan_tag_handling_info_local);
    ...
    local_offloading_mngt_ind = cJSON_GetObjectItemCaseSensitive(dnn_configuration_1JSON, "localOffloadingMngtInd");
    if (local_offloading_mngt_ind) {
    if (!cJSON_IsBool(local_offloading_mngt_ind)) {
        ogs_error("OpenAPI_dnn_configuration_1_parseFromJSON() failed [local_offloading_mngt_ind]");
        goto end;
    }
    }
