...
)
{
    ...
    mdt_configuration_1_local_var->sensor_measurement_lte_list = sensor_measurement_lte_list;
    ...
    mdt_configuration_1_local_var->report_amount_per_measurement_lte = report_amount_per_measurement_lte;
    mdt_configuration_1_local_var->report_amount_per_measurement_nr = report_amount_per_measurement_nr;
    ...
    mdt_configuration_1_local_var->is_mn_only_ind = is_mn_only_ind;
    mdt_configuration_1_local_var->mn_only_ind = mn_only_ind;
    ...
    mdt_configuration_1_local_var->is_event_threshold_sinr_nr = is_event_threshold_sinr_nr;
    mdt_configuration_1_local_var->event_threshold_sinr_nr = event_threshold_sinr_nr;
    mdt_configuration_1_local_var->bluetooth_measurement_nr = bluetooth_measurement_nr;
    mdt_configuration_1_local_var->bluetooth_measurement_lte = bluetooth_measurement_lte;
    mdt_configuration_1_local_var->wlan_measurement_nr = wlan_measurement_nr;
    mdt_configuration_1_local_var->wlan_measurement_lte = wlan_measurement_lte;
    mdt_configuration_1_local_var->slice_area_scope = slice_area_scope;
...
void OpenAPI_mdt_configuration_1_free(OpenAPI_mdt_configuration_1_t *mdt_configuration_1)
{
    ...
    if (mdt_configuration_1->area_scope) {
        OpenAPI_area_scope_1_free(mdt_configuration_1->area_scope);
    ...
    if (mdt_configuration_1->sensor_measurement_lte_list) {
        OpenAPI_list_free(mdt_configuration_1->sensor_measurement_lte_list);
        mdt_configuration_1->sensor_measurement_lte_list = NULL;
    }
    ...
    if (mdt_configuration_1->report_amount_per_measurement_lte) {
        OpenAPI_list_for_each(mdt_configuration_1->report_amount_per_measurement_lte, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(mdt_configuration_1->report_amount_per_measurement_lte);
        mdt_configuration_1->report_amount_per_measurement_lte = NULL;
    }
    if (mdt_configuration_1->report_amount_per_measurement_nr) {
        OpenAPI_list_for_each(mdt_configuration_1->report_amount_per_measurement_nr, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(mdt_configuration_1->report_amount_per_measurement_nr);
        mdt_configuration_1->report_amount_per_measurement_nr = NULL;
    }
    ...
    if (mdt_configuration_1->bluetooth_measurement_nr) {
        OpenAPI_bluetooth_measurement_1_free(mdt_configuration_1->bluetooth_measurement_nr);
        mdt_configuration_1->bluetooth_measurement_nr = NULL;
    }
    if (mdt_configuration_1->bluetooth_measurement_lte) {
        OpenAPI_bluetooth_measurement_1_free(mdt_configuration_1->bluetooth_measurement_lte);
        mdt_configuration_1->bluetooth_measurement_lte = NULL;
    }
    if (mdt_configuration_1->wlan_measurement_nr) {
        OpenAPI_wlan_measurement_1_free(mdt_configuration_1->wlan_measurement_nr);
        mdt_configuration_1->wlan_measurement_nr = NULL;
    }
    if (mdt_configuration_1->wlan_measurement_lte) {
        OpenAPI_wlan_measurement_1_free(mdt_configuration_1->wlan_measurement_lte);
        mdt_configuration_1->wlan_measurement_lte = NULL;
    }
    if (mdt_configuration_1->slice_area_scope) {
        OpenAPI_list_for_each(mdt_configuration_1->slice_area_scope, node) {
            OpenAPI_slice_scope_per_plmn_1_free(node->data);
        }
        OpenAPI_list_free(mdt_configuration_1->slice_area_scope);
        mdt_configuration_1->slice_area_scope = NULL;
    }
...
cJSON *OpenAPI_mdt_configuration_1_convertToJSON(OpenAPI_mdt_configuration_1_t *mdt_configuration_1)
{
    ...
    if (mdt_configuration_1->area_scope) {
    cJSON *area_scope_local_JSON = OpenAPI_area_scope_1_convertToJSON(mdt_configuration_1->area_scope);
    ...
    OpenAPI_list_for_each(mdt_configuration_1->measurement_lte_list, node) {
    ...
    OpenAPI_list_for_each(mdt_configuration_1->measurement_nr_list, node) {
    ...
    OpenAPI_list_for_each(mdt_configuration_1->sensor_measurement_list, node) {
    ...
    if (mdt_configuration_1->sensor_measurement_lte_list != OpenAPI_sensor_measurement_NULL) {
    ...
    if (sensor_measurement_lte_listList == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [sensor_measurement_lte_list]");
        goto end;
    }
    OpenAPI_list_for_each(mdt_configuration_1->sensor_measurement_lte_list, node) {
    ...
    OpenAPI_list_for_each(mdt_configuration_1->reporting_trigger_list, node) {
    ...
    if (mdt_configuration_1->report_amount_per_measurement_lte != OpenAPI_report_amount_mdt_NULL) {
    ...
    if (report_amount_per_measurement_lte == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [report_amount_per_measurement_lte]");
        goto end;
    }
    ...
    if (mdt_configuration_1->report_amount_per_measurement_nr != OpenAPI_report_amount_mdt_NULL) {
    ...
    if (report_amount_per_measurement_nr == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [report_amount_per_measurement_nr]");
        goto end;
    }
    ...
    if (mdt_configuration_1->is_mn_only_ind) {
    if (cJSON_AddBoolToObject(item, "mnOnlyInd", mdt_configuration_1->mn_only_ind) == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [mn_only_ind]");
        goto end;
    }
    }
    ...
    OpenAPI_list_for_each(mdt_configuration_1->event_list, node) {
    ...
    OpenAPI_list_for_each(mdt_configuration_1->add_positioning_method_list, node) {
    ...
    OpenAPI_list_for_each(mdt_configuration_1->inter_freq_target_list, node) {
        cJSON *itemLocal = OpenAPI_inter_freq_target_info_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [inter_freq_target_list]");
            goto end;
        }
    ...
    if (mdt_configuration_1->is_event_threshold_sinr_nr) {
    if (cJSON_AddNumberToObject(item, "eventThresholdSinrNr", mdt_configuration_1->event_threshold_sinr_nr) == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [event_threshold_sinr_nr]");
        goto end;
    }
    }

    if (mdt_configuration_1->bluetooth_measurement_nr) {
    cJSON *bluetooth_measurement_nr_local_JSON = OpenAPI_bluetooth_measurement_1_convertToJSON(mdt_configuration_1->bluetooth_measurement_nr);
    if (bluetooth_measurement_nr_local_JSON == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [bluetooth_measurement_nr]");
        goto end;
    }
    ...
    if (mdt_configuration_1->bluetooth_measurement_lte) {
    cJSON *bluetooth_measurement_lte_local_JSON = OpenAPI_bluetooth_measurement_1_convertToJSON(mdt_configuration_1->bluetooth_measurement_lte);
    if (bluetooth_measurement_lte_local_JSON == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [bluetooth_measurement_lte]");
        goto end;
    }
    ...
    if (mdt_configuration_1->wlan_measurement_nr) {
    cJSON *wlan_measurement_nr_local_JSON = OpenAPI_wlan_measurement_1_convertToJSON(mdt_configuration_1->wlan_measurement_nr);
    if (wlan_measurement_nr_local_JSON == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [wlan_measurement_nr]");
        goto end;
    }
    ...
    if (mdt_configuration_1->wlan_measurement_lte) {
    cJSON *wlan_measurement_lte_local_JSON = OpenAPI_wlan_measurement_1_convertToJSON(mdt_configuration_1->wlan_measurement_lte);
    if (wlan_measurement_lte_local_JSON == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [wlan_measurement_lte]");
        goto end;
    }
    ...
    if (slice_area_scopeList == NULL) {
        ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [slice_area_scope]");
        goto end;
    }
    OpenAPI_list_for_each(mdt_configuration_1->slice_area_scope, node) {
        cJSON *itemLocal = OpenAPI_slice_scope_per_plmn_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_mdt_configuration_1_convertToJSON() failed [slice_area_scope]");
            goto end;
        }
...
OpenAPI_mdt_configuration_1_t *OpenAPI_mdt_configuration_1_parseFromJSON(cJSON *mdt_configuration_1JSON)
{
    ...
    OpenAPI_area_scope_1_t *area_scope_local_nonprim = NULL;
    ...
    OpenAPI_bluetooth_measurement_1_t *bluetooth_measurement_nr_local_nonprim = NULL;
    cJSON *bluetooth_measurement_lte = NULL;
    OpenAPI_bluetooth_measurement_1_t *bluetooth_measurement_lte_local_nonprim = NULL;
    cJSON *wlan_measurement_nr = NULL;
    OpenAPI_wlan_measurement_1_t *wlan_measurement_nr_local_nonprim = NULL;
    cJSON *wlan_measurement_lte = NULL;
    OpenAPI_wlan_measurement_1_t *wlan_measurement_lte_local_nonprim = NULL;
    ...
    if (area_scope) {
    area_scope_local_nonprim = OpenAPI_area_scope_1_parseFromJSON(area_scope);
    if (!area_scope_local_nonprim) {
        ogs_error("OpenAPI_area_scope_1_parseFromJSON failed [area_scope]");
        goto end;
    }
    }
    ...
    sensor_measurement_lte_list = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "sensorMeasurementLteList");
    if (sensor_measurement_lte_list) {
        cJSON *sensor_measurement_lte_list_local = NULL;
        if (!cJSON_IsArray(sensor_measurement_lte_list)) {
            ogs_error("OpenAPI_mdt_configuration_1_parseFromJSON() failed [sensor_measurement_lte_list]");
            goto end;
        }
        ...
        if (sensor_measurement_lte_listList->count == 0) {
            ogs_error("OpenAPI_mdt_configuration_1_parseFromJSON() failed: Expected sensor_measurement_lte_listList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    report_amount_per_measurement_lte = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "reportAmountPerMeasurementLte");
    ...
    report_amount_per_measurement_nr = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "reportAmountPerMeasurementNr");
    ...
    mn_only_ind = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "mnOnlyInd");
    if (mn_only_ind) {
    if (!cJSON_IsBool(mn_only_ind)) {
        ogs_error("OpenAPI_mdt_configuration_1_parseFromJSON() failed [mn_only_ind]");
        goto end;
    }
    }
    ...
    if (inter_freq_target_list) {
        ...
        cJSON_ArrayForEach(inter_freq_target_list_local, inter_freq_target_list) {
            ...
            OpenAPI_inter_freq_target_info_1_t *inter_freq_target_listItem = OpenAPI_inter_freq_target_info_1_parseFromJSON(inter_freq_target_list_local);
    ...
    event_threshold_sinr_nr = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "eventThresholdSinrNr");
    if (event_threshold_sinr_nr) {
    if (!cJSON_IsNumber(event_threshold_sinr_nr)) {
        ogs_error("OpenAPI_mdt_configuration_1_parseFromJSON() failed [event_threshold_sinr_nr]");
        goto end;
    }
    }

    bluetooth_measurement_nr = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "bluetoothMeasurementNr");
    if (bluetooth_measurement_nr) {
    bluetooth_measurement_nr_local_nonprim = OpenAPI_bluetooth_measurement_1_parseFromJSON(bluetooth_measurement_nr);
    if (!bluetooth_measurement_nr_local_nonprim) {
        ogs_error("OpenAPI_bluetooth_measurement_1_parseFromJSON failed [bluetooth_measurement_nr]");
        goto end;
    }
    }

    bluetooth_measurement_lte = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "bluetoothMeasurementLte");
    if (bluetooth_measurement_lte) {
    bluetooth_measurement_lte_local_nonprim = OpenAPI_bluetooth_measurement_1_parseFromJSON(bluetooth_measurement_lte);
    if (!bluetooth_measurement_lte_local_nonprim) {
        ogs_error("OpenAPI_bluetooth_measurement_1_parseFromJSON failed [bluetooth_measurement_lte]");
        goto end;
    }
    }

    wlan_measurement_nr = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "wlanMeasurementNr");
    if (wlan_measurement_nr) {
    wlan_measurement_nr_local_nonprim = OpenAPI_wlan_measurement_1_parseFromJSON(wlan_measurement_nr);
    if (!wlan_measurement_nr_local_nonprim) {
        ogs_error("OpenAPI_wlan_measurement_1_parseFromJSON failed [wlan_measurement_nr]");
        goto end;
    }
    }

    wlan_measurement_lte = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "wlanMeasurementLte");
    if (wlan_measurement_lte) {
    wlan_measurement_lte_local_nonprim = OpenAPI_wlan_measurement_1_parseFromJSON(wlan_measurement_lte);
    if (!wlan_measurement_lte_local_nonprim) {
        ogs_error("OpenAPI_wlan_measurement_1_parseFromJSON failed [wlan_measurement_lte]");
        goto end;
    }
    }

    slice_area_scope = cJSON_GetObjectItemCaseSensitive(mdt_configuration_1JSON, "sliceAreaScope");
    if (slice_area_scope) {
        cJSON *slice_area_scope_local = NULL;
        if (!cJSON_IsArray(slice_area_scope)) {
            ogs_error("OpenAPI_mdt_configuration_1_parseFromJSON() failed [slice_area_scope]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(slice_area_scope_local, slice_area_scope) {
            ...
            OpenAPI_slice_scope_per_plmn_1_t *slice_area_scopeItem = OpenAPI_slice_scope_per_plmn_1_parseFromJSON(slice_area_scope_local);
    ...
    if (area_scope_local_nonprim) {
        OpenAPI_area_scope_1_free(area_scope_local_nonprim);
    ...
    if (bluetooth_measurement_nr_local_nonprim) {
        OpenAPI_bluetooth_measurement_1_free(bluetooth_measurement_nr_local_nonprim);
        bluetooth_measurement_nr_local_nonprim = NULL;
    }
    if (bluetooth_measurement_lte_local_nonprim) {
        OpenAPI_bluetooth_measurement_1_free(bluetooth_measurement_lte_local_nonprim);
        bluetooth_measurement_lte_local_nonprim = NULL;
    }
    if (wlan_measurement_nr_local_nonprim) {
        OpenAPI_wlan_measurement_1_free(wlan_measurement_nr_local_nonprim);
        wlan_measurement_nr_local_nonprim = NULL;
    }
    if (wlan_measurement_lte_local_nonprim) {
        OpenAPI_wlan_measurement_1_free(wlan_measurement_lte_local_nonprim);
