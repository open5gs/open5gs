...
cJSON *OpenAPI_location_reporting_configuration_1_convertToJSON(OpenAPI_location_reporting_configuration_1_t *location_reporting_configuration_1)
{
    ...
    if (location_reporting_configuration_1->accuracy != OpenAPI_location_accuracy_NULL) {
    if (cJSON_AddStringToObject(item, "accuracy", OpenAPI_location_accuracy_ToString(location_reporting_configuration_1->accuracy)) == NULL) {
        ogs_error("OpenAPI_location_reporting_configuration_1_convertToJSON() failed [accuracy]");
        goto end;
    }
    }

    if (location_reporting_configuration_1->n3gpp_accuracy != OpenAPI_location_accuracy_NULL) {
    if (cJSON_AddStringToObject(item, "n3gppAccuracy", OpenAPI_location_accuracy_ToString(location_reporting_configuration_1->n3gpp_accuracy)) == NULL) {
...
OpenAPI_location_reporting_configuration_1_t *OpenAPI_location_reporting_configuration_1_parseFromJSON(cJSON *location_reporting_configuration_1JSON)
{
    ...
    cJSON *one_time = NULL;
    cJSON *accuracy = NULL;
    OpenAPI_location_accuracy_e accuracyVariable = 0;
    cJSON *n3gpp_accuracy = NULL;
    OpenAPI_location_accuracy_e n3gpp_accuracyVariable = 0;
    ...
    if (!cJSON_IsString(accuracy)) {
        ogs_error("OpenAPI_location_reporting_configuration_1_parseFromJSON() failed [accuracy]");
        goto end;
    }
    accuracyVariable = OpenAPI_location_accuracy_FromString(accuracy->valuestring);
    }

    n3gpp_accuracy = cJSON_GetObjectItemCaseSensitive(location_reporting_configuration_1JSON, "n3gppAccuracy");
    if (n3gpp_accuracy) {
    if (!cJSON_IsString(n3gpp_accuracy)) {
        ogs_error("OpenAPI_location_reporting_configuration_1_parseFromJSON() failed [n3gpp_accuracy]");
        goto end;
    }
    n3gpp_accuracyVariable = OpenAPI_location_accuracy_FromString(n3gpp_accuracy->valuestring);
    }
    ...
    location_reporting_configuration_1_local_var = OpenAPI_location_reporting_configuration_1_create (
        ...
        n3gpp_accuracy ? n3gpp_accuracyVariable : 0
    );
