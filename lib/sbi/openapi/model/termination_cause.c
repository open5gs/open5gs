...
{
    const char *termination_causeArray[] =  { "NULL", "ALL_SDF_DEACTIVATION", "PDU_SESSION_TERMINATION", "PS_TO_CS_HO", "INSUFFICIENT_SERVER_RESOURCES", "INSUFFICIENT_QOS_FLOW_RESOURCES", "SPONSORED_DATA_CONNECTIVITY_DISALLOWED", "REQUEST_QOS_NOT_SUPPORTED_IN_PLMN", "UE_ADDR_RELEASE", "SMF_FAILURE", "REFLECTIVE_QOS_NOT_SUPPORTED_IN_UE" };
