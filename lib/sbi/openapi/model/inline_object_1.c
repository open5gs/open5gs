...
)
{
    ...
    inline_object_1_local_var->binary_data_n2_information_ext1 = binary_data_n2_information_ext1;
    inline_object_1_local_var->binary_data_n2_information_ext2 = binary_data_n2_information_ext2;
    inline_object_1_local_var->binary_data_n2_information_ext3 = binary_data_n2_information_ext3;
    inline_object_1_local_var->binary_data_n2_information_ext4 = binary_data_n2_information_ext4;
    inline_object_1_local_var->binary_data_n2_information_ext5 = binary_data_n2_information_ext5;
    inline_object_1_local_var->binary_data_n2_information_ext6 = binary_data_n2_information_ext6;
    inline_object_1_local_var->binary_data_n2_information_ext7 = binary_data_n2_information_ext7;
    inline_object_1_local_var->binary_data_n2_information_ext8 = binary_data_n2_information_ext8;
    inline_object_1_local_var->binary_data_n2_information_ext9 = binary_data_n2_information_ext9;
    inline_object_1_local_var->binary_data_n2_information_ext10 = binary_data_n2_information_ext10;
    inline_object_1_local_var->binary_data_n2_information_ext11 = binary_data_n2_information_ext11;
    inline_object_1_local_var->binary_data_n2_information_ext12 = binary_data_n2_information_ext12;
    inline_object_1_local_var->binary_data_n2_information_ext13 = binary_data_n2_information_ext13;
    inline_object_1_local_var->binary_data_n2_information_ext14 = binary_data_n2_information_ext14;
    inline_object_1_local_var->binary_data_n2_information_ext15 = binary_data_n2_information_ext15;
    inline_object_1_local_var->binary_data_n2_information_ext16 = binary_data_n2_information_ext16;
...
void OpenAPI_inline_object_1_free(OpenAPI_inline_object_1_t *inline_object_1)
{
    ...
    OpenAPI_ue_context_relocate_data_free(inline_object_1->json_data);
    ogs_free(inline_object_1->binary_data_gtpc_message->data);
    ogs_free(inline_object_1->binary_data_n2_information->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext1->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext2->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext3->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext4->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext5->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext6->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext7->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext8->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext9->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext10->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext11->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext12->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext13->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext14->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext15->data);
    ogs_free(inline_object_1->binary_data_n2_information_ext16->data);
...
cJSON *OpenAPI_inline_object_1_convertToJSON(OpenAPI_inline_object_1_t *inline_object_1)
{
    ...
    cJSON *json_data_local_JSON = OpenAPI_ue_context_relocate_data_convertToJSON(inline_object_1->json_data);
    ...
    if (inline_object_1->binary_data_gtpc_message) {
    char* encoded_str_binary_data_gtpc_message = OpenAPI_base64encode(inline_object_1->binary_data_gtpc_message->data,inline_object_1->binary_data_gtpc_message->len);
    if (cJSON_AddStringToObject(item, "binaryDataGtpcMessage", encoded_str_binary_data_gtpc_message) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_gtpc_message]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_gtpc_message);
    }

    if (inline_object_1->binary_data_n2_information) {
    char* encoded_str_binary_data_n2_information = OpenAPI_base64encode(inline_object_1->binary_data_n2_information->data,inline_object_1->binary_data_n2_information->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2Information", encoded_str_binary_data_n2_information) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information);
    }

    if (inline_object_1->binary_data_n2_information_ext1) {
    char* encoded_str_binary_data_n2_information_ext1 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext1->data,inline_object_1->binary_data_n2_information_ext1->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt1", encoded_str_binary_data_n2_information_ext1) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext1);
    }

    if (inline_object_1->binary_data_n2_information_ext2) {
    char* encoded_str_binary_data_n2_information_ext2 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext2->data,inline_object_1->binary_data_n2_information_ext2->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt2", encoded_str_binary_data_n2_information_ext2) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext2);
    }

    if (inline_object_1->binary_data_n2_information_ext3) {
    char* encoded_str_binary_data_n2_information_ext3 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext3->data,inline_object_1->binary_data_n2_information_ext3->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt3", encoded_str_binary_data_n2_information_ext3) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext3);
    }

    if (inline_object_1->binary_data_n2_information_ext4) {
    char* encoded_str_binary_data_n2_information_ext4 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext4->data,inline_object_1->binary_data_n2_information_ext4->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt4", encoded_str_binary_data_n2_information_ext4) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    char* encoded_str_binary_data_n2_information_ext5 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext5->data,inline_object_1->binary_data_n2_information_ext5->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt5", encoded_str_binary_data_n2_information_ext5) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext5);
    }

    if (inline_object_1->binary_data_n2_information_ext6) {
    char* encoded_str_binary_data_n2_information_ext6 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext6->data,inline_object_1->binary_data_n2_information_ext6->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt6", encoded_str_binary_data_n2_information_ext6) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext6);
    }

    if (inline_object_1->binary_data_n2_information_ext7) {
    char* encoded_str_binary_data_n2_information_ext7 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext7->data,inline_object_1->binary_data_n2_information_ext7->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt7", encoded_str_binary_data_n2_information_ext7) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext7);
    }

    if (inline_object_1->binary_data_n2_information_ext8) {
    char* encoded_str_binary_data_n2_information_ext8 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext8->data,inline_object_1->binary_data_n2_information_ext8->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt8", encoded_str_binary_data_n2_information_ext8) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext8);
    }

    if (inline_object_1->binary_data_n2_information_ext9) {
    char* encoded_str_binary_data_n2_information_ext9 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext9->data,inline_object_1->binary_data_n2_information_ext9->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt9", encoded_str_binary_data_n2_information_ext9) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext9);
    }

    if (inline_object_1->binary_data_n2_information_ext10) {
    char* encoded_str_binary_data_n2_information_ext10 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext10->data,inline_object_1->binary_data_n2_information_ext10->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt10", encoded_str_binary_data_n2_information_ext10) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext10);
    }

    if (inline_object_1->binary_data_n2_information_ext11) {
    char* encoded_str_binary_data_n2_information_ext11 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext11->data,inline_object_1->binary_data_n2_information_ext11->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt11", encoded_str_binary_data_n2_information_ext11) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext11);
    }

    if (inline_object_1->binary_data_n2_information_ext12) {
    char* encoded_str_binary_data_n2_information_ext12 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext12->data,inline_object_1->binary_data_n2_information_ext12->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt12", encoded_str_binary_data_n2_information_ext12) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext12);
    }

    if (inline_object_1->binary_data_n2_information_ext13) {
    char* encoded_str_binary_data_n2_information_ext13 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext13->data,inline_object_1->binary_data_n2_information_ext13->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt13", encoded_str_binary_data_n2_information_ext13) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext13);
    }

    if (inline_object_1->binary_data_n2_information_ext14) {
    char* encoded_str_binary_data_n2_information_ext14 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext14->data,inline_object_1->binary_data_n2_information_ext14->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt14", encoded_str_binary_data_n2_information_ext14) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext14);
    }

    if (inline_object_1->binary_data_n2_information_ext15) {
    char* encoded_str_binary_data_n2_information_ext15 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext15->data,inline_object_1->binary_data_n2_information_ext15->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt15", encoded_str_binary_data_n2_information_ext15) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ogs_free(encoded_str_binary_data_n2_information_ext15);
    }

    if (inline_object_1->binary_data_n2_information_ext16) {
    char* encoded_str_binary_data_n2_information_ext16 = OpenAPI_base64encode(inline_object_1->binary_data_n2_information_ext16->data,inline_object_1->binary_data_n2_information_ext16->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt16", encoded_str_binary_data_n2_information_ext16) == NULL) {
        ogs_error("OpenAPI_inline_object_1_convertToJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
