...
)
{
    ...
    pdu_session_status_cfg_1_local_var->is_rat_type_required_null = is_rat_type_required_null;
    pdu_session_status_cfg_1_local_var->is_rat_type_required = is_rat_type_required;
    pdu_session_status_cfg_1_local_var->rat_type_required = rat_type_required;
...
cJSON *OpenAPI_pdu_session_status_cfg_1_convertToJSON(OpenAPI_pdu_session_status_cfg_1_t *pdu_session_status_cfg_1)
{
    ...
    if (pdu_session_status_cfg_1->is_rat_type_required) {
    if (cJSON_AddBoolToObject(item, "ratTypeRequired", pdu_session_status_cfg_1->rat_type_required) == NULL) {
        ogs_error("OpenAPI_pdu_session_status_cfg_1_convertToJSON() failed [rat_type_required]");
        goto end;
    }
    } else if (pdu_session_status_cfg_1->is_rat_type_required_null) {
...
OpenAPI_pdu_session_status_cfg_1_t *OpenAPI_pdu_session_status_cfg_1_parseFromJSON(cJSON *pdu_session_status_cfg_1JSON)
{
    ...
    rat_type_required = cJSON_GetObjectItemCaseSensitive(pdu_session_status_cfg_1JSON, "ratTypeRequired");
    if (rat_type_required) {
    if (!cJSON_IsNull(rat_type_required)) {
    if (!cJSON_IsBool(rat_type_required)) {
        ogs_error("OpenAPI_pdu_session_status_cfg_1_parseFromJSON() failed [rat_type_required]");
        goto end;
    }
    }
    }
