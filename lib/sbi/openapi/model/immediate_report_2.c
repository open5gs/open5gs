...
cJSON *OpenAPI_immediate_report_2_convertToJSON(OpenAPI_immediate_report_2_t *immediate_report_2)
{
    ...
    if (immediate_report_2->subscription_data_sets) {
    cJSON *subscription_data_sets_local_JSON = OpenAPI_subscription_data_sets_1_convertToJSON(immediate_report_2->subscription_data_sets);
    if (subscription_data_sets_local_JSON == NULL) {
        ogs_error("OpenAPI_immediate_report_2_convertToJSON() failed [subscription_data_sets]");
        goto end;
    }
...
{
    OpenAPI_immediate_report_2_t *immediate_report_2_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    ...
    subscription_data_sets = cJSON_GetObjectItemCaseSensitive(immediate_report_2JSON, "SubscriptionDataSets");
    ...
    shared_data_list = cJSON_GetObjectItemCaseSensitive(immediate_report_2JSON, "SharedDataList");
    if (shared_data_list) {
    ...
    immediate_report_2_local_var = OpenAPI_immediate_report_2_create (
