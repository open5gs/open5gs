...
)
{
    ...
    subscription_data_sets_1_local_var->lcs_subscription_data = lcs_subscription_data;
    ...
    subscription_data_sets_1_local_var->a2x_data = a2x_data;
    subscription_data_sets_1_local_var->ranging_sl_privacy_data = ranging_sl_privacy_data;
...
void OpenAPI_subscription_data_sets_1_free(OpenAPI_subscription_data_sets_1_t *subscription_data_sets_1)
{
    ...
    if (subscription_data_sets_1->lcs_subscription_data) {
        OpenAPI_lcs_subscription_data_1_free(subscription_data_sets_1->lcs_subscription_data);
        subscription_data_sets_1->lcs_subscription_data = NULL;
    }
    ...
    if (subscription_data_sets_1->a2x_data) {
        OpenAPI_a2x_subscription_data_1_free(subscription_data_sets_1->a2x_data);
        subscription_data_sets_1->a2x_data = NULL;
    }
    if (subscription_data_sets_1->ranging_sl_privacy_data) {
        OpenAPI_ranging_sl_privacy_data_1_free(subscription_data_sets_1->ranging_sl_privacy_data);
        subscription_data_sets_1->ranging_sl_privacy_data = NULL;
    }
...
cJSON *OpenAPI_subscription_data_sets_1_convertToJSON(OpenAPI_subscription_data_sets_1_t *subscription_data_sets_1)
{
    ...
    if (subscription_data_sets_1->lcs_subscription_data) {
    cJSON *lcs_subscription_data_local_JSON = OpenAPI_lcs_subscription_data_1_convertToJSON(subscription_data_sets_1->lcs_subscription_data);
    if (lcs_subscription_data_local_JSON == NULL) {
        ogs_error("OpenAPI_subscription_data_sets_1_convertToJSON() failed [lcs_subscription_data]");
        goto end;
    }
    ...
    if (subscription_data_sets_1->a2x_data) {
    cJSON *a2x_data_local_JSON = OpenAPI_a2x_subscription_data_1_convertToJSON(subscription_data_sets_1->a2x_data);
    if (a2x_data_local_JSON == NULL) {
        ogs_error("OpenAPI_subscription_data_sets_1_convertToJSON() failed [a2x_data]");
        goto end;
    }
    ...
    if (subscription_data_sets_1->ranging_sl_privacy_data) {
    cJSON *ranging_sl_privacy_data_local_JSON = OpenAPI_ranging_sl_privacy_data_1_convertToJSON(subscription_data_sets_1->ranging_sl_privacy_data);
    if (ranging_sl_privacy_data_local_JSON == NULL) {
        ogs_error("OpenAPI_subscription_data_sets_1_convertToJSON() failed [ranging_sl_privacy_data]");
        goto end;
    }
...
OpenAPI_subscription_data_sets_1_t *OpenAPI_subscription_data_sets_1_parseFromJSON(cJSON *subscription_data_sets_1JSON)
{
    ...
    OpenAPI_lcs_subscription_data_1_t *lcs_subscription_data_local_nonprim = NULL;
    cJSON *v2x_data = NULL;
    ...
    cJSON *a2x_data = NULL;
    OpenAPI_a2x_subscription_data_1_t *a2x_data_local_nonprim = NULL;
    cJSON *ranging_sl_privacy_data = NULL;
    OpenAPI_ranging_sl_privacy_data_1_t *ranging_sl_privacy_data_local_nonprim = NULL;
    ...
    lcs_subscription_data = cJSON_GetObjectItemCaseSensitive(subscription_data_sets_1JSON, "lcsSubscriptionData");
    if (lcs_subscription_data) {
    lcs_subscription_data_local_nonprim = OpenAPI_lcs_subscription_data_1_parseFromJSON(lcs_subscription_data);
    if (!lcs_subscription_data_local_nonprim) {
        ogs_error("OpenAPI_lcs_subscription_data_1_parseFromJSON failed [lcs_subscription_data]");
        goto end;
    }
    }
    ...
    a2x_data = cJSON_GetObjectItemCaseSensitive(subscription_data_sets_1JSON, "a2xData");
    if (a2x_data) {
    a2x_data_local_nonprim = OpenAPI_a2x_subscription_data_1_parseFromJSON(a2x_data);
    if (!a2x_data_local_nonprim) {
        ogs_error("OpenAPI_a2x_subscription_data_1_parseFromJSON failed [a2x_data]");
        goto end;
    }
    }

    ranging_sl_privacy_data = cJSON_GetObjectItemCaseSensitive(subscription_data_sets_1JSON, "rangingSlPrivacyData");
    if (ranging_sl_privacy_data) {
    ranging_sl_privacy_data_local_nonprim = OpenAPI_ranging_sl_privacy_data_1_parseFromJSON(ranging_sl_privacy_data);
    if (!ranging_sl_privacy_data_local_nonprim) {
        ogs_error("OpenAPI_ranging_sl_privacy_data_1_parseFromJSON failed [ranging_sl_privacy_data]");
        goto end;
    }
    }
    ...
    if (lcs_subscription_data_local_nonprim) {
        OpenAPI_lcs_subscription_data_1_free(lcs_subscription_data_local_nonprim);
    ...
    if (a2x_data_local_nonprim) {
        OpenAPI_a2x_subscription_data_1_free(a2x_data_local_nonprim);
        a2x_data_local_nonprim = NULL;
    }
    if (ranging_sl_privacy_data_local_nonprim) {
        OpenAPI_ranging_sl_privacy_data_1_free(ranging_sl_privacy_data_local_nonprim);
