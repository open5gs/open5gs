...
{
    const char *request_triggerArray[] =  { "NULL", "LOC_CH", "PRA_CH", "SERV_AREA_CH", "RFSP_CH", "ALLOWED_NSSAI_CH", "UE_AMBR_CH", "UE_SLICE_MBR_CH", "SMF_SELECT_CH", "ACCESS_TYPE_CH", "NWDAF_DATA_CH", "TARGET_NSSAI", "SLICE_REPLACE_MGMT", "FEAT_RENEG", "PARTIALLY_ALLOWED_NSSAI_CH", "SNSSAIS_PARTIALLY_REJECTED_CH", "REJECTED_SNSSAIS_CH", "PENDING_NSSAI_CH", "RAT_TYPE_CH", "SLICE_REPLACE_OUTCOME", "ENERGY_SAV_IND_CH" };
