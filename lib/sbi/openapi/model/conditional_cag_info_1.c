...
{
    OpenAPI_conditional_cag_info_1_t *conditional_cag_info_1_local_var = ogs_malloc(sizeof(OpenAPI_conditional_cag_info_1_t));
    ogs_assert(conditional_cag_info_1_local_var);

    conditional_cag_info_1_local_var->allowed_cag_list = allowed_cag_list;
    conditional_cag_info_1_local_var->is_cag_only_indicator = is_cag_only_indicator;
    conditional_cag_info_1_local_var->cag_only_indicator = cag_only_indicator;
    conditional_cag_info_1_local_var->valid_time_period = valid_time_period;
    conditional_cag_info_1_local_var->cag_specific_valid_time_period_list = cag_specific_valid_time_period_list;

    return conditional_cag_info_1_local_var;
}
...
void OpenAPI_conditional_cag_info_1_free(OpenAPI_conditional_cag_info_1_t *conditional_cag_info_1)
{
    ...
    if (NULL == conditional_cag_info_1) {
        return;
    }
    if (conditional_cag_info_1->allowed_cag_list) {
        OpenAPI_list_for_each(conditional_cag_info_1->allowed_cag_list, node) {
            ogs_free(node->data);
        }
        OpenAPI_list_free(conditional_cag_info_1->allowed_cag_list);
        conditional_cag_info_1->allowed_cag_list = NULL;
    }
    if (conditional_cag_info_1->valid_time_period) {
        OpenAPI_valid_time_period_1_free(conditional_cag_info_1->valid_time_period);
        conditional_cag_info_1->valid_time_period = NULL;
    }
    if (conditional_cag_info_1->cag_specific_valid_time_period_list) {
        OpenAPI_list_for_each(conditional_cag_info_1->cag_specific_valid_time_period_list, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_valid_time_period_1_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(conditional_cag_info_1->cag_specific_valid_time_period_list);
        conditional_cag_info_1->cag_specific_valid_time_period_list = NULL;
    }
    ogs_free(conditional_cag_info_1);
}
...
cJSON *OpenAPI_conditional_cag_info_1_convertToJSON(OpenAPI_conditional_cag_info_1_t *conditional_cag_info_1)
{
    ...
    if (conditional_cag_info_1 == NULL) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [ConditionalCagInfo_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!conditional_cag_info_1->allowed_cag_list) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [allowed_cag_list]");
        return NULL;
    }
    ...
    if (conditional_cag_info_1->is_cag_only_indicator) {
    if (cJSON_AddBoolToObject(item, "cagOnlyIndicator", conditional_cag_info_1->cag_only_indicator) == NULL) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [cag_only_indicator]");
        goto end;
    }
    }

    if (conditional_cag_info_1->valid_time_period) {
    cJSON *valid_time_period_local_JSON = OpenAPI_valid_time_period_1_convertToJSON(conditional_cag_info_1->valid_time_period);
    if (valid_time_period_local_JSON == NULL) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [valid_time_period]");
        goto end;
    }
    ...
    if (cag_specific_valid_time_period_list == NULL) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [cag_specific_valid_time_period_list]");
        goto end;
    }
    ...
    if (conditional_cag_info_1->cag_specific_valid_time_period_list) {
        OpenAPI_list_for_each(conditional_cag_info_1->cag_specific_valid_time_period_list, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                ...
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed [inner]");
                goto end;
            }
...
{
    OpenAPI_conditional_cag_info_1_t *conditional_cag_info_1_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    ...
    allowed_cag_list = cJSON_GetObjectItemCaseSensitive(conditional_cag_info_1JSON, "allowedCagList");
    if (!allowed_cag_list) {
        ogs_error("OpenAPI_conditional_cag_info_1_parseFromJSON() failed [allowed_cag_list]");
        goto end;
    }
    ...
    cag_only_indicator = cJSON_GetObjectItemCaseSensitive(conditional_cag_info_1JSON, "cagOnlyIndicator");
    if (cag_only_indicator) {
    if (!cJSON_IsBool(cag_only_indicator)) {
        ogs_error("OpenAPI_conditional_cag_info_1_parseFromJSON() failed [cag_only_indicator]");
        goto end;
    }
    }

    valid_time_period = cJSON_GetObjectItemCaseSensitive(conditional_cag_info_1JSON, "validTimePeriod");
    ...
    cag_specific_valid_time_period_list = cJSON_GetObjectItemCaseSensitive(conditional_cag_info_1JSON, "cagSpecificValidTimePeriodList");
    ...
    conditional_cag_info_1_local_var = OpenAPI_conditional_cag_info_1_create (
...
OpenAPI_conditional_cag_info_1_t *OpenAPI_conditional_cag_info_1_copy(OpenAPI_conditional_cag_info_1_t *dst, OpenAPI_conditional_cag_info_1_t *src)
{
    ...
    ogs_assert(src);
    item = OpenAPI_conditional_cag_info_1_convertToJSON(src);
    if (!item) {
        ogs_error("OpenAPI_conditional_cag_info_1_convertToJSON() failed");
        return NULL;
    }
    ...
    OpenAPI_conditional_cag_info_1_free(dst);
    dst = OpenAPI_conditional_cag_info_1_parseFromJSON(item);
    cJSON_Delete(item);
