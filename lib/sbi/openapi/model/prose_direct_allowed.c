...
{
    const char *prose_direct_allowedArray[] =  { "NULL", "ANNOUNCE", "MONITOR", "RESTRICTD_ANNOUNCE", "RESTRICTD_MONITOR", "DISCOVERER", "DISCOVEREE", "BROADCAST", "GROUPCAST", "UNICAST", "LAYER2_RELAY", "LAYER3_RELAY", "LAYER3_REMOTE", "LAYER2_UE_RELAY", "LAYER3_UE_RELAY", "LAYER2_END", "LAYER3_END", "LAYER2_RELAY_INTERMEDIATE", "LAYER3_RELAY_INTERMEDIATE", "LAYER2_RELAY_MULTI_HOP", "LAYER3_RELAY_MULTI_HOP", "LAYER3_UE_RELAY_MULTI_HOP", "LAYER3_END_MULTI_HOP", "LAYER2_REMOTE_MULTI_HOP" };
