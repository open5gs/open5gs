...
{
    OpenAPI_cag_provision_information_1_t *cag_provision_information_1_local_var = ogs_malloc(sizeof(OpenAPI_cag_provision_information_1_t));
    ogs_assert(cag_provision_information_1_local_var);

    cag_provision_information_1_local_var->cag_info = cag_info;
    cag_provision_information_1_local_var->common_valid_time_period_list = common_valid_time_period_list;
    cag_provision_information_1_local_var->additional_valid_time_period_list = additional_valid_time_period_list;
    cag_provision_information_1_local_var->provision_operation = provision_operation;

    return cag_provision_information_1_local_var;
}
...
void OpenAPI_cag_provision_information_1_free(OpenAPI_cag_provision_information_1_t *cag_provision_information_1)
{
    ...
    if (NULL == cag_provision_information_1) {
        return;
    }
    if (cag_provision_information_1->cag_info) {
        OpenAPI_list_for_each(cag_provision_information_1->cag_info, node) {
            ogs_free(node->data);
        }
        OpenAPI_list_free(cag_provision_information_1->cag_info);
        cag_provision_information_1->cag_info = NULL;
    }
    if (cag_provision_information_1->common_valid_time_period_list) {
        OpenAPI_list_for_each(cag_provision_information_1->common_valid_time_period_list, node) {
            OpenAPI_valid_time_period_1_free(node->data);
        }
        OpenAPI_list_free(cag_provision_information_1->common_valid_time_period_list);
        cag_provision_information_1->common_valid_time_period_list = NULL;
    }
    if (cag_provision_information_1->additional_valid_time_period_list) {
        OpenAPI_list_for_each(cag_provision_information_1->additional_valid_time_period_list, node) {
            OpenAPI_map_t *localKeyValue = (OpenAPI_map_t*)node->data;
            ogs_free(localKeyValue->key);
            OpenAPI_valid_time_period_1_free(localKeyValue->value);
            OpenAPI_map_free(localKeyValue);
        }
        OpenAPI_list_free(cag_provision_information_1->additional_valid_time_period_list);
        cag_provision_information_1->additional_valid_time_period_list = NULL;
    }
    ogs_free(cag_provision_information_1);
}
...
cJSON *OpenAPI_cag_provision_information_1_convertToJSON(OpenAPI_cag_provision_information_1_t *cag_provision_information_1)
{
    ...
    if (cag_provision_information_1 == NULL) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [CagProvisionInformation_1]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (!cag_provision_information_1->cag_info) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [cag_info]");
        return NULL;
    }
    ...
    if (common_valid_time_period_listList == NULL) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [common_valid_time_period_list]");
        goto end;
    }
    OpenAPI_list_for_each(cag_provision_information_1->common_valid_time_period_list, node) {
        cJSON *itemLocal = OpenAPI_valid_time_period_1_convertToJSON(node->data);
        if (itemLocal == NULL) {
            ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [common_valid_time_period_list]");
            goto end;
        }
    ...
    if (additional_valid_time_period_list == NULL) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [additional_valid_time_period_list]");
        goto end;
    }
    ...
    if (cag_provision_information_1->additional_valid_time_period_list) {
        OpenAPI_list_for_each(cag_provision_information_1->additional_valid_time_period_list, node) {
            ...
            cJSON *itemLocal = localKeyValue->value ?
                OpenAPI_valid_time_period_1_convertToJSON(localKeyValue->value) :
                cJSON_CreateNull();
            if (itemLocal == NULL) {
                ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [inner]");
                goto end;
            }
    ...
    if (cag_provision_information_1->provision_operation != OpenAPI_cag_provision_operation_NULL) {
    if (cJSON_AddStringToObject(item, "provisionOperation", OpenAPI_cag_provision_operation_ToString(cag_provision_information_1->provision_operation)) == NULL) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed [provision_operation]");
        goto end;
    }
    }
...
{
    OpenAPI_cag_provision_information_1_t *cag_provision_information_1_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    cJSON *cag_info = NULL;
    ...
    cag_info = cJSON_GetObjectItemCaseSensitive(cag_provision_information_1JSON, "cagInfo");
    if (!cag_info) {
        ogs_error("OpenAPI_cag_provision_information_1_parseFromJSON() failed [cag_info]");
        goto end;
    }
    ...
    common_valid_time_period_list = cJSON_GetObjectItemCaseSensitive(cag_provision_information_1JSON, "commonValidTimePeriodList");
    if (common_valid_time_period_list) {
        ...
        if (!cJSON_IsArray(common_valid_time_period_list)) {
            ogs_error("OpenAPI_cag_provision_information_1_parseFromJSON() failed [common_valid_time_period_list]");
            goto end;
        }
        ...
        cJSON_ArrayForEach(common_valid_time_period_list_local, common_valid_time_period_list) {
            ...
            OpenAPI_valid_time_period_1_t *common_valid_time_period_listItem = OpenAPI_valid_time_period_1_parseFromJSON(common_valid_time_period_list_local);
    ...
    additional_valid_time_period_list = cJSON_GetObjectItemCaseSensitive(cag_provision_information_1JSON, "additionalValidTimePeriodList");
            ...
            cJSON_ArrayForEach(additional_valid_time_period_list_local_map, additional_valid_time_period_list) {
                ...
                if (cJSON_IsObject(localMapObject)) {
                    localMapKeyPair = OpenAPI_map_create(
                        ogs_strdup(localMapObject->string), OpenAPI_valid_time_period_1_parseFromJSON(localMapObject));
    ...
    provision_operation = cJSON_GetObjectItemCaseSensitive(cag_provision_information_1JSON, "provisionOperation");
    if (provision_operation) {
    if (!cJSON_IsString(provision_operation)) {
        ogs_error("OpenAPI_cag_provision_information_1_parseFromJSON() failed [provision_operation]");
        goto end;
    }
    provision_operationVariable = OpenAPI_cag_provision_operation_FromString(provision_operation->valuestring);
    }

    cag_provision_information_1_local_var = OpenAPI_cag_provision_information_1_create (
        cag_infoList,
...
OpenAPI_cag_provision_information_1_t *OpenAPI_cag_provision_information_1_copy(OpenAPI_cag_provision_information_1_t *dst, OpenAPI_cag_provision_information_1_t *src)
{
    ...
    ogs_assert(src);
    item = OpenAPI_cag_provision_information_1_convertToJSON(src);
    if (!item) {
        ogs_error("OpenAPI_cag_provision_information_1_convertToJSON() failed");
        return NULL;
    }
    ...
    OpenAPI_cag_provision_information_1_free(dst);
    dst = OpenAPI_cag_provision_information_1_parseFromJSON(item);
    cJSON_Delete(item);
