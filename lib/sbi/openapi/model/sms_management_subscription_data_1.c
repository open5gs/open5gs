...
cJSON *OpenAPI_sms_management_subscription_data_1_convertToJSON(OpenAPI_sms_management_subscription_data_1_t *sms_management_subscription_data_1)
{
    ...
    if (sms_management_subscription_data_1->mt_sms_subscribed) {
    ...
    if (sms_management_subscription_data_1->mt_sms_barring_all) {
    ...
    if (sms_management_subscription_data_1->mt_sms_barring_roaming) {
    ...
    if (sms_management_subscription_data_1->mo_sms_subscribed) {
    ...
    if (sms_management_subscription_data_1->mo_sms_barring_all) {
    ...
    if (sms_management_subscription_data_1->mo_sms_barring_roaming) {
