...
)
{
    ...
    sms_management_subscription_data_1_local_var->shared_trace_data_id = shared_trace_data_id;
    sms_management_subscription_data_1_local_var->chf_group_id = chf_group_id;
    sms_management_subscription_data_1_local_var->_3gpp_charging_characteristics = _3gpp_charging_characteristics;
...
void OpenAPI_sms_management_subscription_data_1_free(OpenAPI_sms_management_subscription_data_1_t *sms_management_subscription_data_1)
{
    ...
    if (sms_management_subscription_data_1->shared_trace_data_id) {
        ogs_free(sms_management_subscription_data_1->shared_trace_data_id);
        sms_management_subscription_data_1->shared_trace_data_id = NULL;
    }
    if (sms_management_subscription_data_1->chf_group_id) {
        ogs_free(sms_management_subscription_data_1->chf_group_id);
        sms_management_subscription_data_1->chf_group_id = NULL;
    }
    if (sms_management_subscription_data_1->_3gpp_charging_characteristics) {
        ogs_free(sms_management_subscription_data_1->_3gpp_charging_characteristics);
        sms_management_subscription_data_1->_3gpp_charging_characteristics = NULL;
    }
...
cJSON *OpenAPI_sms_management_subscription_data_1_convertToJSON(OpenAPI_sms_management_subscription_data_1_t *sms_management_subscription_data_1)
{
    ...
    if (sms_management_subscription_data_1->shared_trace_data_id) {
    if (cJSON_AddStringToObject(item, "sharedTraceDataId", sms_management_subscription_data_1->shared_trace_data_id) == NULL) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_convertToJSON() failed [shared_trace_data_id]");
        goto end;
    }
    }

    if (sms_management_subscription_data_1->chf_group_id) {
    if (cJSON_AddStringToObject(item, "chfGroupId", sms_management_subscription_data_1->chf_group_id) == NULL) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_convertToJSON() failed [chf_group_id]");
        goto end;
    }
    }

    if (sms_management_subscription_data_1->_3gpp_charging_characteristics) {
    if (cJSON_AddStringToObject(item, "3gppChargingCharacteristics", sms_management_subscription_data_1->_3gpp_charging_characteristics) == NULL) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_convertToJSON() failed [_3gpp_charging_characteristics]");
        goto end;
    }
    }
...
OpenAPI_sms_management_subscription_data_1_t *OpenAPI_sms_management_subscription_data_1_parseFromJSON(cJSON *sms_management_subscription_data_1JSON)
{
    ...
    shared_trace_data_id = cJSON_GetObjectItemCaseSensitive(sms_management_subscription_data_1JSON, "sharedTraceDataId");
    if (shared_trace_data_id) {
    if (!cJSON_IsString(shared_trace_data_id) && !cJSON_IsNull(shared_trace_data_id)) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_parseFromJSON() failed [shared_trace_data_id]");
        goto end;
    }
    }

    chf_group_id = cJSON_GetObjectItemCaseSensitive(sms_management_subscription_data_1JSON, "chfGroupId");
    if (chf_group_id) {
    if (!cJSON_IsString(chf_group_id) && !cJSON_IsNull(chf_group_id)) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_parseFromJSON() failed [chf_group_id]");
        goto end;
    }
    }

    _3gpp_charging_characteristics = cJSON_GetObjectItemCaseSensitive(sms_management_subscription_data_1JSON, "3gppChargingCharacteristics");
    ...
    if (!cJSON_IsString(_3gpp_charging_characteristics) && !cJSON_IsNull(_3gpp_charging_characteristics)) {
        ogs_error("OpenAPI_sms_management_subscription_data_1_parseFromJSON() failed [_3gpp_charging_characteristics]");
        goto end;
    }
    }
