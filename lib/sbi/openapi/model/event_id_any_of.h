...
typedef enum { OpenAPI_event_id_any_of_NULL = 0, OpenAPI_event_id_any_of_LOAD_LEVEL_INFORMATION, OpenAPI_event_id_any_of_NETWORK_PERFORMANCE, OpenAPI_event_id_any_of_NF_LOAD, OpenAPI_event_id_any_of_SERVICE_EXPERIENCE, OpenAPI_event_id_any_of_UE_MOBILITY, OpenAPI_event_id_any_of_UE_COMMUNICATION, OpenAPI_event_id_any_of_QOS_SUSTAINABILITY, OpenAPI_event_id_any_of_ABNORMAL_BEHAVIOUR, OpenAPI_event_id_any_of_USER_DATA_CONGESTION, OpenAPI_event_id_any_of_NSI_LOAD_LEVEL, OpenAPI_event_id_any_of_SM_CONGESTION, OpenAPI_event_id_any_of_DISPERSION, OpenAPI_event_id_any_of_RED_TRANS_EXP, OpenAPI_event_id_any_of_WLAN_PERFORMANCE, OpenAPI_event_id_any_of_DN_PERFORMANCE } OpenAPI_event_id_any_of_e;
