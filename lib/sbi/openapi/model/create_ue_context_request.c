...
)
{
    ...
    ogs_assert(create_ue_context_request_local_var);

    create_ue_context_request_local_var->json_data = json_data;
    create_ue_context_request_local_var->binary_data_n2_information = binary_data_n2_information;
    create_ue_context_request_local_var->binary_data_n2_information_ext1 = binary_data_n2_information_ext1;
    create_ue_context_request_local_var->binary_data_n2_information_ext2 = binary_data_n2_information_ext2;
    create_ue_context_request_local_var->binary_data_n2_information_ext3 = binary_data_n2_information_ext3;
    create_ue_context_request_local_var->binary_data_n2_information_ext4 = binary_data_n2_information_ext4;
    create_ue_context_request_local_var->binary_data_n2_information_ext5 = binary_data_n2_information_ext5;
    create_ue_context_request_local_var->binary_data_n2_information_ext6 = binary_data_n2_information_ext6;
    create_ue_context_request_local_var->binary_data_n2_information_ext7 = binary_data_n2_information_ext7;
    create_ue_context_request_local_var->binary_data_n2_information_ext8 = binary_data_n2_information_ext8;
    create_ue_context_request_local_var->binary_data_n2_information_ext9 = binary_data_n2_information_ext9;
    create_ue_context_request_local_var->binary_data_n2_information_ext10 = binary_data_n2_information_ext10;
    create_ue_context_request_local_var->binary_data_n2_information_ext11 = binary_data_n2_information_ext11;
    create_ue_context_request_local_var->binary_data_n2_information_ext12 = binary_data_n2_information_ext12;
    create_ue_context_request_local_var->binary_data_n2_information_ext13 = binary_data_n2_information_ext13;
...
void OpenAPI_create_ue_context_request_free(OpenAPI_create_ue_context_request_t *create_ue_context_request)
{
    ...
    if (create_ue_context_request->json_data) {
        OpenAPI_ue_context_create_data_free(create_ue_context_request->json_data);
        create_ue_context_request->json_data = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information) {
        ogs_free(create_ue_context_request->binary_data_n2_information->data);
        create_ue_context_request->binary_data_n2_information = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext1) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext1->data);
        create_ue_context_request->binary_data_n2_information_ext1 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext2) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext2->data);
        create_ue_context_request->binary_data_n2_information_ext2 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext3) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext3->data);
        create_ue_context_request->binary_data_n2_information_ext3 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext4) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext4->data);
        create_ue_context_request->binary_data_n2_information_ext4 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext5) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext5->data);
        create_ue_context_request->binary_data_n2_information_ext5 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext6) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext6->data);
        create_ue_context_request->binary_data_n2_information_ext6 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext7) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext7->data);
        create_ue_context_request->binary_data_n2_information_ext7 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext8) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext8->data);
        create_ue_context_request->binary_data_n2_information_ext8 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext9) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext9->data);
        create_ue_context_request->binary_data_n2_information_ext9 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext10) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext10->data);
        create_ue_context_request->binary_data_n2_information_ext10 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext11) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext11->data);
        create_ue_context_request->binary_data_n2_information_ext11 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext12) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext12->data);
        create_ue_context_request->binary_data_n2_information_ext12 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext13) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext13->data);
        create_ue_context_request->binary_data_n2_information_ext13 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext14) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext14->data);
        create_ue_context_request->binary_data_n2_information_ext14 = NULL;
    }
    if (create_ue_context_request->binary_data_n2_information_ext15) {
        ogs_free(create_ue_context_request->binary_data_n2_information_ext15->data);
        create_ue_context_request->binary_data_n2_information_ext15 = NULL;
    }
...
cJSON *OpenAPI_create_ue_context_request_convertToJSON(OpenAPI_create_ue_context_request_t *create_ue_context_request)
{
    ...
    if (create_ue_context_request == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [CreateUEContext_request]");
        return NULL;
    }

    item = cJSON_CreateObject();
    if (create_ue_context_request->json_data) {
    cJSON *json_data_local_JSON = OpenAPI_ue_context_create_data_convertToJSON(create_ue_context_request->json_data);
    if (json_data_local_JSON == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [json_data]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information) {
    char* encoded_str_binary_data_n2_information = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information->data,create_ue_context_request->binary_data_n2_information->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2Information", encoded_str_binary_data_n2_information) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext1) {
    char* encoded_str_binary_data_n2_information_ext1 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext1->data,create_ue_context_request->binary_data_n2_information_ext1->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt1", encoded_str_binary_data_n2_information_ext1) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext2) {
    char* encoded_str_binary_data_n2_information_ext2 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext2->data,create_ue_context_request->binary_data_n2_information_ext2->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt2", encoded_str_binary_data_n2_information_ext2) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext2]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext3) {
    char* encoded_str_binary_data_n2_information_ext3 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext3->data,create_ue_context_request->binary_data_n2_information_ext3->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt3", encoded_str_binary_data_n2_information_ext3) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext4) {
    char* encoded_str_binary_data_n2_information_ext4 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext4->data,create_ue_context_request->binary_data_n2_information_ext4->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt4", encoded_str_binary_data_n2_information_ext4) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext5) {
    char* encoded_str_binary_data_n2_information_ext5 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext5->data,create_ue_context_request->binary_data_n2_information_ext5->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt5", encoded_str_binary_data_n2_information_ext5) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext6) {
    char* encoded_str_binary_data_n2_information_ext6 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext6->data,create_ue_context_request->binary_data_n2_information_ext6->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt6", encoded_str_binary_data_n2_information_ext6) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext7) {
    char* encoded_str_binary_data_n2_information_ext7 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext7->data,create_ue_context_request->binary_data_n2_information_ext7->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt7", encoded_str_binary_data_n2_information_ext7) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext8) {
    char* encoded_str_binary_data_n2_information_ext8 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext8->data,create_ue_context_request->binary_data_n2_information_ext8->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt8", encoded_str_binary_data_n2_information_ext8) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext9) {
    char* encoded_str_binary_data_n2_information_ext9 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext9->data,create_ue_context_request->binary_data_n2_information_ext9->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt9", encoded_str_binary_data_n2_information_ext9) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext10) {
    char* encoded_str_binary_data_n2_information_ext10 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext10->data,create_ue_context_request->binary_data_n2_information_ext10->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt10", encoded_str_binary_data_n2_information_ext10) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext11) {
    char* encoded_str_binary_data_n2_information_ext11 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext11->data,create_ue_context_request->binary_data_n2_information_ext11->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt11", encoded_str_binary_data_n2_information_ext11) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext12) {
    char* encoded_str_binary_data_n2_information_ext12 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext12->data,create_ue_context_request->binary_data_n2_information_ext12->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt12", encoded_str_binary_data_n2_information_ext12) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext13) {
    char* encoded_str_binary_data_n2_information_ext13 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext13->data,create_ue_context_request->binary_data_n2_information_ext13->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt13", encoded_str_binary_data_n2_information_ext13) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext14) {
    char* encoded_str_binary_data_n2_information_ext14 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext14->data,create_ue_context_request->binary_data_n2_information_ext14->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt14", encoded_str_binary_data_n2_information_ext14) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext15) {
    char* encoded_str_binary_data_n2_information_ext15 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext15->data,create_ue_context_request->binary_data_n2_information_ext15->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt15", encoded_str_binary_data_n2_information_ext15) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    if (create_ue_context_request->binary_data_n2_information_ext16) {
    char* encoded_str_binary_data_n2_information_ext16 = OpenAPI_base64encode(create_ue_context_request->binary_data_n2_information_ext16->data,create_ue_context_request->binary_data_n2_information_ext16->len);
    if (cJSON_AddStringToObject(item, "binaryDataN2InformationExt16", encoded_str_binary_data_n2_information_ext16) == NULL) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
...
{
    OpenAPI_create_ue_context_request_t *create_ue_context_request_local_var = NULL;
    OpenAPI_lnode_t *node = NULL;
    ...
    if (!cJSON_IsString(binary_data_n2_information)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information]");
        goto end;
    }
    ...
    binary_data_n2_information_ext1 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt1");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext1)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext1]");
        goto end;
    }
    ...
    binary_data_n2_information_ext2 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt2");
    ...
    binary_data_n2_information_ext3 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt3");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext3)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext3]");
        goto end;
    }
    ...
    binary_data_n2_information_ext4 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt4");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext4)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext4]");
        goto end;
    }
    ...
    binary_data_n2_information_ext5 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt5");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext5)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext5]");
        goto end;
    }
    ...
    binary_data_n2_information_ext6 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt6");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext6)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext6]");
        goto end;
    }
    ...
    binary_data_n2_information_ext7 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt7");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext7)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext7]");
        goto end;
    }
    ...
    binary_data_n2_information_ext8 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt8");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext8)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext8]");
        goto end;
    }
    ...
    binary_data_n2_information_ext9 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt9");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext9)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext9]");
        goto end;
    }
    ...
    binary_data_n2_information_ext10 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt10");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext10)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext10]");
        goto end;
    }
    ...
    binary_data_n2_information_ext11 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt11");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext11)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext11]");
        goto end;
    }
    ...
    binary_data_n2_information_ext12 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt12");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext12)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext12]");
        goto end;
    }
    ...
    binary_data_n2_information_ext13 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt13");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext13)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext13]");
        goto end;
    }
    ...
    binary_data_n2_information_ext14 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt14");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext14)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext14]");
        goto end;
    }
    ...
    binary_data_n2_information_ext15 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt15");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext15)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext15]");
        goto end;
    }
    ...
    binary_data_n2_information_ext16 = cJSON_GetObjectItemCaseSensitive(create_ue_context_requestJSON, "binaryDataN2InformationExt16");
    ...
    if (!cJSON_IsString(binary_data_n2_information_ext16)) {
        ogs_error("OpenAPI_create_ue_context_request_parseFromJSON() failed [binary_data_n2_information_ext16]");
        goto end;
    }
    ...
    if (json_data_local_nonprim) {
        OpenAPI_ue_context_create_data_free(json_data_local_nonprim);
...
OpenAPI_create_ue_context_request_t *OpenAPI_create_ue_context_request_copy(OpenAPI_create_ue_context_request_t *dst, OpenAPI_create_ue_context_request_t *src)
{
    ...
    ogs_assert(src);
    item = OpenAPI_create_ue_context_request_convertToJSON(src);
    if (!item) {
        ogs_error("OpenAPI_create_ue_context_request_convertToJSON() failed");
        return NULL;
    }
    ...
    OpenAPI_create_ue_context_request_free(dst);
    dst = OpenAPI_create_ue_context_request_parseFromJSON(item);
    cJSON_Delete(item);
