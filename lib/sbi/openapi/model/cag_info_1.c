...
void OpenAPI_cag_info_1_free(OpenAPI_cag_info_1_t *cag_info_1)
{
    ...
    if (cag_info_1->cag_list) {
        OpenAPI_list_for_each(cag_info_1->cag_list, node) {
            ogs_free(node->data);
        }
        OpenAPI_list_free(cag_info_1->cag_list);
...
cJSON *OpenAPI_cag_info_1_convertToJSON(OpenAPI_cag_info_1_t *cag_info_1)
{
    ...
    if (!cag_info_1->cag_list) {
        ogs_error("OpenAPI_cag_info_1_convertToJSON() failed [cag_list]");
        return NULL;
    }
...
OpenAPI_cag_info_1_t *OpenAPI_cag_info_1_parseFromJSON(cJSON *cag_info_1JSON)
{
    ...
    if (!cag_list) {
        ogs_error("OpenAPI_cag_info_1_parseFromJSON() failed [cag_list]");
        goto end;
    }
