...
ies.append({ "ie_type" : "F-TEID", "ie_value" : "S5/S8-U SGW F-TEID", "presence" : "C", "instance" : "2", "comment" : "This IE shall be included on the S5/S8 interface for an E-UTRAN Initial Attach, a Handover from Trusted or Untrusted Non-3GPP IP Access to E-UTRAN, a PDP Context Activation, a Handover from Trusted or Untrusted Non-3GPP IP Access to UTRAN/GERAN, a UE Requested PDN Connectivity and an MME triggered PDN connection restoration (see clause31.3 of TS23.007[17])."})
...
ies.append({ "ie_type" : "F-TEID", "ie_value" : "S2b-U ePDG F-TEID", "presence" : "C", "instance" : "5", "comment" : "This IE shall be included on the S2b interface for an Attach with GTP on S2b, a UE initiated Connectivity to Additional PDN with GTP on S2b, a Handover to Untrusted Non-3GPP IP Access with GTP on S2b, an Initial Attach for emergency session (GTP on S2b) and an ePDG triggered PDN connection restoration (see clause31.3A of TS23.007[17])."})
...
ies.append({ "ie_type" : "Bearer QoS", "ie_value" : "Bearer Level QoS", "presence" : "M", "instance" : "0", "comment" : "Bearer Level QoS information.During a PDN connection restoration after an PGW-C/SMF change procedure, this IE shall be set to the Bearer Level QoS that was set by the PGW-C/SMF before the restoration of the PDN connection."})
...
ies.append({ "ie_type" : "Group Id", "ie_value" : "Group Id", "presence" : "O", "instance" : "0", "comment" : "When present, this IE shall identify the group to which the PDN connection pertains (see clause31.6 of TS23.007[17])."})
group_list["PGW Change Info"] = { "index" : "314", "type" : "214", "ies" : ies }
# [Table -2: Bearer Context within Create Bearer Request] Index = 22
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies.append({ "ie_type" : "Maximum Packet Loss Rate", "ie_value" : "Maximum Packet Loss Rate", "presence" : "O", "instance" : "0", "comment" : "This IE may be included on the S5/S8 interfaces if the PGW needs to send Maximum Packet Loss Rate as specified in clause5.4.1 of TS23.401[3]. This IE is only applicable for QCI 1. "})
group_list["Bearer Context"] = { "index" : "193", "type" : "93", "ies" : added_ies }
...
added_ies = group_list["Overload Control Information"]["ies"]
# [Table -2: Bearer Context to be modified within Modify Bearer Request] Index = 34
added_ies = group_list["Bearer Context"]["ies"]
# [Table -3: Bearer Context to be removed within Modify Bearer Request] Index = 35
added_ies = group_list["Bearer Context"]["ies"]
# [Table 7.2.7-4: Overload Control Information within Modify Bearer Request] Index = 36
added_ies = group_list["Overload Control Information"]["ies"]
# [Table -2: Bearer Context modified within Modify Bearer Response] Index = 38
added_ies = group_list["Bearer Context"]["ies"]
# [Table -3: Bearer Context marked for removal within Modify Bearer Response] Index = 39
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies = group_list["Overload Control Information"]["ies"]
# [Table .2-2: Bearer Context within Delete Bearer Request] Index = 46
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies = group_list["Overload Control Information"]["ies"]
# [Table .2-2: Bearer Context within Delete Bearer Response] Index = 54
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies = group_list["Overload Control Information"]["ies"]
# [Table .1-2: Bearer Context within Modify Bearer Command] Index = 64
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies = group_list["Overload Control Information"]["ies"]
# [Table -2: Bearer Context within Update Bearer Request] Index = 69
added_ies = group_list["Bearer Context"]["ies"]
added_ies.append({ "ie_type" : "APCO", "ie_value" : "Additional Protocol Configuration Options", "presence" : "CO", "instance" : "0", "comment" : "The PGW shall include the Additional Prococol Configuration Options (APCO) IE on the S2b interface, including the list of available P-CSCF addresses, as part of the P-CSCF restoration extension procedure for the untrusted WLAN access, as specified in TS23.380[61]."})
group_list["Bearer Context"] = { "index" : "193", "type" : "93", "ies" : added_ies }
...
added_ies = group_list["PGW Change Info"]["ies"]
# [Table -2: Bearer Context within Update Bearer Response] Index = 74
added_ies = group_list["Bearer Context"]["ies"]
# [Table 7.2.16-3: Overload Control Information within Update Bearer Response] Index = 75
added_ies = group_list["Overload Control Information"]["ies"]
# [Table .1-2: Bearer Context within Delete Bearer Command] Index = 77
added_ies = group_list["Bearer Context"]["ies"]
# [Table 7.2.17.1-3: Overload Control Information within Delete Bearer Command] Index = 78
added_ies = group_list["Overload Control Information"]["ies"]
# [Table .2-2: Bearer Context within Delete Bearer Failure Indication] Index = 80
added_ies = group_list["Bearer Context"]["ies"]
# [Table 7.2.17-3: Overload Control Information within Delete Bearer Failure Indication] Index = 81
added_ies = group_list["Overload Control Information"]["ies"]
# [Table -2: Bearer Context within Create Indirect Data Forwarding Tunnel Request] Index = 83
added_ies = group_list["Bearer Context"]["ies"]
# [Table -2: Bearer Context within Create Indirect Data Forwarding Tunnel Response] Index = 85
added_ies = group_list["Bearer Context"]["ies"]
...
ies.append({ "ie_type" : "PGW Change Info", "ie_value" : "PGW Change Info", "presence" : "CO", "instance" : "0", "comment" : "This IE shall be sent over the S10/N26 interface if available from a source AMF/MME to a target MME.This IE shall also be sent over N26 interface from a source MME to a target AMF if available and if the target AMF is required to restore the PDN connection to an alternative PGW-C/SMF.See clause31.5 of TS23.007[17]."})
ies.append({ "ie_type" : "IP Address", "ie_value" : "New PGW-C/SMF IP Address", "presence" : "CO", "instance" : "2", "comment" : "This IE shall be included when the Pending PDN connection Restoration Indication flag is set to 1 and if a new PGW-C/SMF IP address is available. (NOTE7)"})
type_list["FQDN"]["max_instance"] = "2"
ies.append({ "ie_type" : "FQDN", "ie_value" : "New PGW Node Name", "presence" : "CO", "instance" : "2", "comment" : "This IE shall be included when the Pending PDN connection Restoration Indication flag is set to 1 and if a new PGW-C/SMF Node Name is available. (NOTE7)"})
...
added_ies = group_list["PGW Change Info"]["ies"]
# [Table -2: Bearer Context] Index = 112
added_ies = group_list["Bearer Context"]["ies"]
...
added_ies = group_list["Remote UE Context"]["ies"]
# [Table 7.3.6-6: PGW Change Info with Context Response] Index = 121
added_ies = group_list["PGW Change Info"]["ies"]
