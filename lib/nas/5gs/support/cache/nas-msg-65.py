...
ies.append({ "iei" : "6E", "value" : "Requested extended DRX parameters", "type" : "Extended DRX parameters", "reference" : "9.11.3.26A", "presence" : "O", "format" : "TLV", "length" : "3-4"})
...
ies.append({ "iei" : "1A", "value" : "Requested WUS assistance information", "type" : "WUS assistance information", "reference" : "9.11.3.71", "presence" : "O", "format" : "TLV", "length" : "3"})
ies.append({ "iei" : "A-", "value" : "N5GC indication", "type" : "N5GC indication", "reference" : "9.11.3.72", "presence" : "O", "format" : "TV", "length" : "1"})
ies.append({ "iei" : "30", "value" : "Requested NB-N1 mode DRX parameters", "type" : "NB-N1 mode DRX parameters", "reference" : "9.11.3.73", "presence" : "O", "format" : "TLV", "length" : "3"})
...
ies.append({ "iei" : "16", "value" : "UE determined PLMN with disaster condition", "type" : "PLMN identity", "reference" : "9.11.3.85", "presence" : "O", "format" : "TLV", "length" : "5"})
ies.append({ "iei" : "2A", "value" : "Requested PEIPS assistance information", "type" : "PEIPS assistance information", "reference" : "9.11.3.80", "presence" : "O", "format" : "TLV", "length" : "3"})
ies.append({ "iei" : "3B", "value" : "Requested T3512 value", "type" : "GPRS timer 3", "reference" : "9.11.2.5", "presence" : "O", "format" : "TLV", "length" : "3"})
...
ies.append({ "iei" : "3F", "value" : "Non-3GPP path switching information", "type" : "Non-3GPP path switching information", "reference" : "9.11.3.102", "presence" : "O", "format" : "TLV", "length" : "3"})
ies.append({ "iei" : "56", "value" : "AUN3 indication", "type" : "AUN3 indication", "reference" : "9.11.3.104", "presence" : "O", "format" : "TLV", "length" : "3"})
ies.append({ "iei" : "64", "value" : "Requested LP-WUSPS assistance information", "type" : "LP-WUSPS assistance information", "reference" : "9.11.3.111", "presence" : "O", "format" : "TLV", "length" : "3"})
