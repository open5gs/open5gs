...
ies.append({ "iei" : "25", "value" : "List of PLMNs to be used in disaster condition", "type" : "List of PLMNs to be used in disaster condition", "reference" : "9.9.3.76", "presence" : "O", "format" : "TLV", "length" : "2-n"})
