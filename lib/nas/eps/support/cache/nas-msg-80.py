...
ies.append({ "iei" : "20", "value" : "Access technology utilization control", "type" : "Access technology utilization control", "reference" : "9.9.3.3A", "presence" : "O", "format" : "TLV", "length" : "2-5"})
