...
ies.append({ "iei" : "64", "value" : "EPS network feature support", "type" : "EPS network feature support", "reference" : "9.9.3.12A", "presence" : "O", "format" : "TLV", "length" : "3-5"})
...
ies.append({ "iei" : "D-", "value" : "Non-3GPP NW policies", "type" : "Non-3GPP NW provided policies", "reference" : "9.9.3.49", "presence" : "O", "format" : "TV", "length" : "1"})
...
ies.append({ "iei" : "35", "value" : "Negotiated WUS assistance information", "type" : "WUS assistance information", "reference" : "9.9.3.62", "presence" : "O", "format" : "TLV", "length" : "3"})
...
ies.append({ "iei" : "37", "value" : "EPS additional request result", "type" : "EPS additional request result", "reference" : "9.9.3.67", "presence" : "O", "format" : "TLV", "length" : "3"})
...
ies.append({ "iei" : "39", "value" : "Maximum time offset", "type" : "GPRS timer 3", "reference" : "9.9.3.16B", "presence" : "O", "format" : "TLV", "length" : "3"})
ies.append({ "iei" : "1F", "value" : "Unavailability configuration", "type" : "Unavailability configuration", "reference" : "9.9.3.70", "presence" : "O", "format" : "TLV", "length" : "3-9"})
...
ies.append({ "iei" : "22", "value" : "Disaster roaming wait range", "type" : "Registration wait range", "reference" : "9.9.3.75", "presence" : "O", "format" : "TLV", "length" : "4"})
...
ies.append({ "iei" : "25", "value" : "List of PLMNs to be used in disaster condition", "type" : "List of PLMNs to be used in disaster condition", "reference" : "9.3.3.76", "presence" : "O", "format" : "TLV", "length" : "2-n"})
