...
typedef enum NGAP_CauseRadioNetwork {
	...
	NGAP_CauseRadioNetwork_eredcap_ue_not_supported	= 57,
	NGAP_CauseRadioNetwork_two_rx_xr_ue_not_supported	= 58,
	NGAP_CauseRadioNetwork_aerial_ue_flight_information_reporting_initiation_failure	= 59,
	NGAP_CauseRadioNetwork_unknown_RAN_AIoT_Device_NGAP_ID	= 60,
	NGAP_CauseRadioNetwork_requested_AIoT_service_area_information_not_served_by_the_gNB	= 61,
	NGAP_CauseRadioNetwork_unknown_AIoT_session	= 62,
	NGAP_CauseRadioNetwork_aiot_device_not_reachable	= 63,
	NGAP_CauseRadioNetwork_multiple_AIoT_session_ID_instances	= 64
