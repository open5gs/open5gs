...
#define NGAP_ProcedureCode_id_TimingSynchronisationStatus	((NGAP_ProcedureCode_t)76)
#define NGAP_ProcedureCode_id_TimingSynchronisationStatusReport	((NGAP_ProcedureCode_t)77)
#define NGAP_ProcedureCode_id_MTCommunicationHandling	((NGAP_ProcedureCode_t)78)
#define NGAP_ProcedureCode_id_RANPagingRequest	((NGAP_ProcedureCode_t)79)
#define NGAP_ProcedureCode_id_BroadcastSessionTransport	((NGAP_ProcedureCode_t)80)
#define NGAP_ProcedureCode_id_NGRemoval	((NGAP_ProcedureCode_t)81)
#define NGAP_ProcedureCode_id_InventoryRequest	((NGAP_ProcedureCode_t)82)
#define NGAP_ProcedureCode_id_InventoryReport	((NGAP_ProcedureCode_t)83)
#define NGAP_ProcedureCode_id_CommandRequest	((NGAP_ProcedureCode_t)84)
#define NGAP_ProcedureCode_id_AIOTSessionRelease	((NGAP_ProcedureCode_t)85)
#define NGAP_ProcedureCode_id_AIOTSessionReleaseRequest	((NGAP_ProcedureCode_t)86)
