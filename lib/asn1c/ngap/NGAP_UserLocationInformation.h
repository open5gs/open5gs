...
typedef enum NGAP_UserLocationInformation_PR {
	...
	NGAP_UserLocationInformation_PR_userLocationInformationN3IWF_with_PortNumber,
...
struct NGAP_UserLocationInformationN3IWF_with_PortNumber;
struct NGAP_ProtocolIE_SingleContainer_14665P73;
...
typedef struct NGAP_UserLocationInformation {
	...
	union NGAP_UserLocationInformation_u {
		...
		struct NGAP_UserLocationInformationN3IWF_with_PortNumber	*userLocationInformationN3IWF_with_PortNumber;
