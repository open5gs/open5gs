...
asn_TYPE_member_t asn_MBR_NGAP_UserLocationInformation_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct NGAP_UserLocationInformation, choice.userLocationInformationN3IWF_with_PortNumber),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_UserLocationInformationN3IWF_with_PortNumber,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 0, offsetof(struct NGAP_UserLocationInformation, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_14665P73,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
