...
#define NGAP_ProtocolIE_ID_id_NetworkControlledRepeaterAuthorized	((NGAP_ProtocolIE_ID_t)367)
#define NGAP_ProtocolIE_ID_id_AdditionalCancelledlocationReportingReferenceIDList	((NGAP_ProtocolIE_ID_t)368)
#define NGAP_ProtocolIE_ID_id_Selected_Target_SNPN_Identity	((NGAP_ProtocolIE_ID_t)369)
#define NGAP_ProtocolIE_ID_id_EquivalentSNPNsList	((NGAP_ProtocolIE_ID_t)370)
#define NGAP_ProtocolIE_ID_id_SelectedNID	((NGAP_ProtocolIE_ID_t)371)
#define NGAP_ProtocolIE_ID_id_SupportedUETypeList	((NGAP_ProtocolIE_ID_t)372)
#define NGAP_ProtocolIE_ID_id_AerialUEsubscriptionInformation	((NGAP_ProtocolIE_ID_t)373)
#define NGAP_ProtocolIE_ID_id_NR_A2X_ServicesAuthorized	((NGAP_ProtocolIE_ID_t)374)
#define NGAP_ProtocolIE_ID_id_LTE_A2X_ServicesAuthorized	((NGAP_ProtocolIE_ID_t)375)
#define NGAP_ProtocolIE_ID_id_NR_A2X_UE_PC5_AggregateMaximumBitRate	((NGAP_ProtocolIE_ID_t)376)
#define NGAP_ProtocolIE_ID_id_LTE_A2X_UE_PC5_AggregateMaximumBitRate	((NGAP_ProtocolIE_ID_t)377)
#define NGAP_ProtocolIE_ID_id_A2X_PC5_QoS_Parameters	((NGAP_ProtocolIE_ID_t)378)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2Multipath	((NGAP_ProtocolIE_ID_t)379)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2UEtoUERelay	((NGAP_ProtocolIE_ID_t)380)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2UEtoUERemote	((NGAP_ProtocolIE_ID_t)381)
#define NGAP_ProtocolIE_ID_id_CandidateRelayUEInformationList	((NGAP_ProtocolIE_ID_t)382)
#define NGAP_ProtocolIE_ID_id_SuccessfulPSCellChangeReportList	((NGAP_ProtocolIE_ID_t)383)
#define NGAP_ProtocolIE_ID_id_IntersystemMobilityFailureforVoiceFallback	((NGAP_ProtocolIE_ID_t)384)
#define NGAP_ProtocolIE_ID_id_TargetCellCRNTI	((NGAP_ProtocolIE_ID_t)385)
#define NGAP_ProtocolIE_ID_id_TimeSinceFailure	((NGAP_ProtocolIE_ID_t)386)
#define NGAP_ProtocolIE_ID_id_RANTimingSynchronisationStatusInfo	((NGAP_ProtocolIE_ID_t)387)
#define NGAP_ProtocolIE_ID_id_RAN_TSSRequestType	((NGAP_ProtocolIE_ID_t)388)
#define NGAP_ProtocolIE_ID_id_RAN_TSSScope	((NGAP_ProtocolIE_ID_t)389)
#define NGAP_ProtocolIE_ID_id_ClockQualityReportingControlInfo	((NGAP_ProtocolIE_ID_t)390)
#define NGAP_ProtocolIE_ID_id_RANfeedbacktype	((NGAP_ProtocolIE_ID_t)391)
#define NGAP_ProtocolIE_ID_id_QoSFlowTSCList	((NGAP_ProtocolIE_ID_t)392)
#define NGAP_ProtocolIE_ID_id_TSCTrafficCharacteristicsFeedback	((NGAP_ProtocolIE_ID_t)393)
#define NGAP_ProtocolIE_ID_id_DownlinkTLContainer	((NGAP_ProtocolIE_ID_t)394)
#define NGAP_ProtocolIE_ID_id_UplinkTLContainer	((NGAP_ProtocolIE_ID_t)395)
#define NGAP_ProtocolIE_ID_id_ANPacketDelayBudgetUL	((NGAP_ProtocolIE_ID_t)396)
#define NGAP_ProtocolIE_ID_id_QosFlowAdditionalInfoList	((NGAP_ProtocolIE_ID_t)397)
#define NGAP_ProtocolIE_ID_id_AssistanceInformationQoE_Meas	((NGAP_ProtocolIE_ID_t)398)
#define NGAP_ProtocolIE_ID_id_MBSCommServiceType	((NGAP_ProtocolIE_ID_t)399)
#define NGAP_ProtocolIE_ID_id_MobileIAB_Authorized	((NGAP_ProtocolIE_ID_t)400)
#define NGAP_ProtocolIE_ID_id_MobileIAB_MTUserLocationInformation	((NGAP_ProtocolIE_ID_t)401)
#define NGAP_ProtocolIE_ID_id_MobileIABNodeIndication	((NGAP_ProtocolIE_ID_t)402)
#define NGAP_ProtocolIE_ID_id_NoPDUSessionIndication	((NGAP_ProtocolIE_ID_t)403)
#define NGAP_ProtocolIE_ID_id_MobileIAB_Supported	((NGAP_ProtocolIE_ID_t)404)
#define NGAP_ProtocolIE_ID_id_CN_MT_CommunicationHandling	((NGAP_ProtocolIE_ID_t)405)
#define NGAP_ProtocolIE_ID_id_FiveGCAction	((NGAP_ProtocolIE_ID_t)406)
#define NGAP_ProtocolIE_ID_id_PagingPolicyDifferentiation	((NGAP_ProtocolIE_ID_t)407)
#define NGAP_ProtocolIE_ID_id_DL_Signalling	((NGAP_ProtocolIE_ID_t)408)
#define NGAP_ProtocolIE_ID_id_PNI_NPN_AreaScopeofMDT	((NGAP_ProtocolIE_ID_t)409)
#define NGAP_ProtocolIE_ID_id_PNI_NPNBasedMDT	((NGAP_ProtocolIE_ID_t)410)
#define NGAP_ProtocolIE_ID_id_SNPN_CellBasedMDT	((NGAP_ProtocolIE_ID_t)411)
#define NGAP_ProtocolIE_ID_id_SNPN_TAIBasedMDT	((NGAP_ProtocolIE_ID_t)412)
#define NGAP_ProtocolIE_ID_id_SNPN_BasedMDT	((NGAP_ProtocolIE_ID_t)413)
#define NGAP_ProtocolIE_ID_id_Partially_Allowed_NSSAI	((NGAP_ProtocolIE_ID_t)414)
#define NGAP_ProtocolIE_ID_id_AssociatedSessionID	((NGAP_ProtocolIE_ID_t)415)
#define NGAP_ProtocolIE_ID_id_MBS_AssistanceInformation	((NGAP_ProtocolIE_ID_t)416)
#define NGAP_ProtocolIE_ID_id_BroadcastTransportFailureTransfer	((NGAP_ProtocolIE_ID_t)417)
#define NGAP_ProtocolIE_ID_id_BroadcastTransportRequestTransfer	((NGAP_ProtocolIE_ID_t)418)
#define NGAP_ProtocolIE_ID_id_BroadcastTransportResponseTransfer	((NGAP_ProtocolIE_ID_t)419)
#define NGAP_ProtocolIE_ID_id_TimeBasedHandoverInformation	((NGAP_ProtocolIE_ID_t)420)
#define NGAP_ProtocolIE_ID_id_DLDiscarding	((NGAP_ProtocolIE_ID_t)421)
#define NGAP_ProtocolIE_ID_id_PDUsetQoSParameters	((NGAP_ProtocolIE_ID_t)422)
#define NGAP_ProtocolIE_ID_id_PDUSetbasedHandlingIndicator	((NGAP_ProtocolIE_ID_t)423)
#define NGAP_ProtocolIE_ID_id_N6JitterInformation	((NGAP_ProtocolIE_ID_t)424)
#define NGAP_ProtocolIE_ID_id_ECNMarkingorCongestionInformationReportingRequest	((NGAP_ProtocolIE_ID_t)425)
#define NGAP_ProtocolIE_ID_id_ECNMarkingorCongestionInformationReportingStatus	((NGAP_ProtocolIE_ID_t)426)
#define NGAP_ProtocolIE_ID_id_ERedCapIndication	((NGAP_ProtocolIE_ID_t)427)
#define NGAP_ProtocolIE_ID_id_XrDeviceWith2Rx	((NGAP_ProtocolIE_ID_t)428)
#define NGAP_ProtocolIE_ID_id_UserPlaneErrorIndicator	((NGAP_ProtocolIE_ID_t)429)
#define NGAP_ProtocolIE_ID_id_SLPositioningRangingServiceInfo	((NGAP_ProtocolIE_ID_t)430)
#define NGAP_ProtocolIE_ID_id_PDUSessionListMTCommHReq	((NGAP_ProtocolIE_ID_t)431)
#define NGAP_ProtocolIE_ID_id_MaximumDataBurstVolume	((NGAP_ProtocolIE_ID_t)432)
#define NGAP_ProtocolIE_ID_id_MN_only_MDT_collection	((NGAP_ProtocolIE_ID_t)433)
#define NGAP_ProtocolIE_ID_id_MBS_NGUFailureIndication	((NGAP_ProtocolIE_ID_t)434)
#define NGAP_ProtocolIE_ID_id_UserPlaneFailureIndication	((NGAP_ProtocolIE_ID_t)435)
#define NGAP_ProtocolIE_ID_id_UserPlaneFailureIndicationReport	((NGAP_ProtocolIE_ID_t)436)
#define NGAP_ProtocolIE_ID_id_SourceSN_to_TargetSN_QMCInfo	((NGAP_ProtocolIE_ID_t)437)
#define NGAP_ProtocolIE_ID_id_QoERVQoEReportingPaths	((NGAP_ProtocolIE_ID_t)438)
#define NGAP_ProtocolIE_ID_id_UserLocationInformationN3IWF_without_PortNumber	((NGAP_ProtocolIE_ID_t)439)
#define NGAP_ProtocolIE_ID_id_AUN3DeviceAccessInfo	((NGAP_ProtocolIE_ID_t)440)
#define NGAP_ProtocolIE_ID_id_TAIMBSSupportList	((NGAP_ProtocolIE_ID_t)441)
#define NGAP_ProtocolIE_ID_id_ExtendedBackupAMFName	((NGAP_ProtocolIE_ID_t)442)
#define NGAP_ProtocolIE_ID_id_ExtendedOldAMF	((NGAP_ProtocolIE_ID_t)443)
#define NGAP_ProtocolIE_ID_id_MBS_UP_FailureIndication	((NGAP_ProtocolIE_ID_t)444)
#define NGAP_ProtocolIE_ID_id_RequestedTNLInfo	((NGAP_ProtocolIE_ID_t)445)
#define NGAP_ProtocolIE_ID_id_Aerial_UE_FlightInformationOngoingReporting_failed	((NGAP_ProtocolIE_ID_t)446)
#define NGAP_ProtocolIE_ID_id_NetworkSliceAreaScopeofMDT	((NGAP_ProtocolIE_ID_t)447)
#define NGAP_ProtocolIE_ID_id_GeographyBasedMDT	((NGAP_ProtocolIE_ID_t)448)
#define NGAP_ProtocolIE_ID_id_MBS_IntendedServiceAreaList	((NGAP_ProtocolIE_ID_t)449)
#define NGAP_ProtocolIE_ID_id_AMF_UE_NGAP_ID2	((NGAP_ProtocolIE_ID_t)450)
#define NGAP_ProtocolIE_ID_id_GUAMIList	((NGAP_ProtocolIE_ID_t)451)
#define NGAP_ProtocolIE_ID_id_GW_Context_Release_Indication	((NGAP_ProtocolIE_ID_t)452)
#define NGAP_ProtocolIE_ID_id_SourceAMF_GUAMI	((NGAP_ProtocolIE_ID_t)453)
#define NGAP_ProtocolIE_ID_id_RequestedNSSAI	((NGAP_ProtocolIE_ID_t)454)
#define NGAP_ProtocolIE_ID_id_Target_RAN_Node_ID	((NGAP_ProtocolIE_ID_t)455)
#define NGAP_ProtocolIE_ID_id_InventoryRequestTransfer	((NGAP_ProtocolIE_ID_t)456)
#define NGAP_ProtocolIE_ID_id_InventoryResponseTransfer	((NGAP_ProtocolIE_ID_t)457)
#define NGAP_ProtocolIE_ID_id_InventoryFailureTransfer	((NGAP_ProtocolIE_ID_t)458)
#define NGAP_ProtocolIE_ID_id_InventoryReportTransfer	((NGAP_ProtocolIE_ID_t)459)
#define NGAP_ProtocolIE_ID_id_CommandRequestTransfer	((NGAP_ProtocolIE_ID_t)460)
#define NGAP_ProtocolIE_ID_id_CommandResponseTransfer	((NGAP_ProtocolIE_ID_t)461)
#define NGAP_ProtocolIE_ID_id_CommandFailureTransfer	((NGAP_ProtocolIE_ID_t)462)
#define NGAP_ProtocolIE_ID_id_AIOTSessionReleaseCommandTransfer	((NGAP_ProtocolIE_ID_t)463)
#define NGAP_ProtocolIE_ID_id_AIOTSessionReleaseCompleteTransfer	((NGAP_ProtocolIE_ID_t)464)
#define NGAP_ProtocolIE_ID_id_AIOTSessionReleaseRequestTransfer	((NGAP_ProtocolIE_ID_t)465)
#define NGAP_ProtocolIE_ID_id_AIoT_CorrelationIdentifier	((NGAP_ProtocolIE_ID_t)466)
#define NGAP_ProtocolIE_ID_id_AIOTFIdentifier	((NGAP_ProtocolIE_ID_t)467)
#define NGAP_ProtocolIE_ID_id_AIoT_DeviceIdentificationRequested	((NGAP_ProtocolIE_ID_t)468)
#define NGAP_ProtocolIE_ID_id_AIoT_RequestedServiceAreaInformation	((NGAP_ProtocolIE_ID_t)469)
#define NGAP_ProtocolIE_ID_id_AIoT_InventoryAssistanceInformation	((NGAP_ProtocolIE_ID_t)470)
#define NGAP_ProtocolIE_ID_id_AIoT_FollowonCommandIndication	((NGAP_ProtocolIE_ID_t)471)
#define NGAP_ProtocolIE_ID_id_RAN_AIOT_Device_NGAP_ID	((NGAP_ProtocolIE_ID_t)472)
#define NGAP_ProtocolIE_ID_id_AIoT_CommandAssistanceInformation	((NGAP_ProtocolIE_ID_t)473)
#define NGAP_ProtocolIE_ID_id_AIoT_NASPDU	((NGAP_ProtocolIE_ID_t)474)
#define NGAP_ProtocolIE_ID_id_AIoT_Support	((NGAP_ProtocolIE_ID_t)475)
#define NGAP_ProtocolIE_ID_id_AIOTFName	((NGAP_ProtocolIE_ID_t)476)
#define NGAP_ProtocolIE_ID_id_LPWUSPSAssistanceInformation	((NGAP_ProtocolIE_ID_t)477)
#define NGAP_ProtocolIE_ID_id_FurtherExtendedUEIdentityIndexValue	((NGAP_ProtocolIE_ID_t)478)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2MHUEtoNetworkRelay	((NGAP_ProtocolIE_ID_t)479)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2MHIntermediateUEtoNetworkRelay	((NGAP_ProtocolIE_ID_t)480)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer2MHRemote	((NGAP_ProtocolIE_ID_t)481)
#define NGAP_ProtocolIE_ID_id_FiveGProSeLayer3MHUEtoNetworkRelay	((NGAP_ProtocolIE_ID_t)482)
#define NGAP_ProtocolIE_ID_id_AdditionalULI	((NGAP_ProtocolIE_ID_t)483)
#define NGAP_ProtocolIE_ID_id_PduSetDelayBudgetDownlink	((NGAP_ProtocolIE_ID_t)484)
#define NGAP_ProtocolIE_ID_id_PduSetDelayBudgetUplink	((NGAP_ProtocolIE_ID_t)485)
#define NGAP_ProtocolIE_ID_id_PduSetErrorRateDownlink	((NGAP_ProtocolIE_ID_t)486)
#define NGAP_ProtocolIE_ID_id_PduSetErrorRateUplink	((NGAP_ProtocolIE_ID_t)487)
#define NGAP_ProtocolIE_ID_id_DLPDUSetInformationMarkingSupportIndication	((NGAP_ProtocolIE_ID_t)488)
#define NGAP_ProtocolIE_ID_id_MonitoringRequestonAvailableBitrate	((NGAP_ProtocolIE_ID_t)489)
#define NGAP_ProtocolIE_ID_id_MMSID	((NGAP_ProtocolIE_ID_t)490)
#define NGAP_ProtocolIE_ID_id_Indication_of_Bitrate_Adaptation	((NGAP_ProtocolIE_ID_t)491)
#define NGAP_ProtocolIE_ID_id_SCGActivationTime	((NGAP_ProtocolIE_ID_t)492)
#define NGAP_ProtocolIE_ID_id_Aerial_UE_FlightInformationReporting	((NGAP_ProtocolIE_ID_t)493)
#define NGAP_ProtocolIE_ID_id_Aerial_UE_FlightInformationReportingControlList	((NGAP_ProtocolIE_ID_t)494)
#define NGAP_ProtocolIE_ID_id_LPWUSDisableIndication	((NGAP_ProtocolIE_ID_t)495)
#define NGAP_ProtocolIE_ID_id_AIoT_SecurityInfo	((NGAP_ProtocolIE_ID_t)496)
