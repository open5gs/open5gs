...
typedef enum NGAP_EventType {
	 ...
	 */
	NGAP_EventType_change_of_serving_cell_and_UE_presence_in_the_Area_of_Interest	= 6,
	NGAP_EventType_report_the_Aerial_UE_flight_information	= 7,
	NGAP_EventType_cancel_the_Aerial_UE_flight_information_reporting	= 8
} e_NGAP_EventType;
