...
#define S1AP_ProtocolIE_ID_id_M4ReportAmount	((S1AP_ProtocolIE_ID_t)346)
#define S1AP_ProtocolIE_ID_id_M5ReportAmount	((S1AP_ProtocolIE_ID_t)347)
#define S1AP_ProtocolIE_ID_id_M6ReportAmount	((S1AP_ProtocolIE_ID_t)348)
#define S1AP_ProtocolIE_ID_id_M7ReportAmount	((S1AP_ProtocolIE_ID_t)349)
#define S1AP_ProtocolIE_ID_id_TimeBasedHandoverInformation	((S1AP_ProtocolIE_ID_t)350)
#define S1AP_ProtocolIE_ID_id_Bearers_SubjectToDLDiscarding_Item	((S1AP_ProtocolIE_ID_t)351)
#define S1AP_ProtocolIE_ID_id_Bearers_SubjectToDLDiscardingList	((S1AP_ProtocolIE_ID_t)352)
#define S1AP_ProtocolIE_ID_id_CoarseUELocationRequested	((S1AP_ProtocolIE_ID_t)353)
#define S1AP_ProtocolIE_ID_id_CoarseUELocation	((S1AP_ProtocolIE_ID_t)354)
#define S1AP_ProtocolIE_ID_id_TimeRefDistribution	((S1AP_ProtocolIE_ID_t)355)
#define S1AP_ProtocolIE_ID_id_RequestedTNLInfo	((S1AP_ProtocolIE_ID_t)356)
