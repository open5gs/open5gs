...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_S1AP_maxRSIndexCellQual_constr_13 CC_NOTUSED = {
...
static int asn_validate_S1AP_subcarrierSpacingSSB_4(const asn_TYPE_descriptor_t *td,
    ...
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz480:
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz960:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_S1AP_InterSystemMeasurementItem_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_S1AP_maxRSIndexCellQual_constr_13,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_InterSystemMeasurementItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8386P86,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
