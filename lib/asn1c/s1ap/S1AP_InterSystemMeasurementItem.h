...
typedef enum S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB {
	 ...
	 */
	S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz480	= 5,
	S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz960	= 6
} e_S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB;

/* Forward declarations */
struct S1AP_ProtocolExtensionContainer_8386P86;
