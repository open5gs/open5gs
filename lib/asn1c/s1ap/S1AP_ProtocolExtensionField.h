...
typedef struct S1AP_E_RABToBeSetupItemHOReq_ExtIEs {
	...
	struct S1AP_E_RABToBeSetupItemHOReq_ExtIEs__extensionValue {
		...
		union S1AP_E_RABToBeSetupItemHOReq_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_SecurityIndication_t	 SecurityIndication;
		} choice;
...
typedef struct S1AP_E_RABSecurityResultItem_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_E_RABSecurityResultItem_ExtIEs__extensionValue {
...
typedef struct S1AP_EventL1LoggedMDTConfig_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_EventL1LoggedMDTConfig_ExtIEs__extensionValue {
...
typedef struct S1AP_HandoverRestrictionList_ExtIEs {
	...
	struct S1AP_HandoverRestrictionList_ExtIEs__extensionValue {
		...
		union S1AP_HandoverRestrictionList_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_RAT_Restrictions_t	 RAT_Restrictions;
		} choice;
...
typedef struct S1AP_ImmediateMDT_ExtIEs {
	...
	struct S1AP_ImmediateMDT_ExtIEs__extensionValue {
		...
		union S1AP_ImmediateMDT_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_SensorMeasurementConfiguration_t	 SensorMeasurementConfiguration;
		} choice;
...
typedef struct S1AP_LastVisitedEUTRANCellInformation_ExtIEs {
	...
	struct S1AP_LastVisitedEUTRANCellInformation_ExtIEs__extensionValue {
		...
		union S1AP_LastVisitedEUTRANCellInformation_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_Cause_t	 Cause;
			S1AP_LastVisitedPSCellList_t	 LastVisitedPSCellList;
		} choice;
...
typedef struct S1AP_LastVisitedPSCellInformation_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_LastVisitedPSCellInformation_ExtIEs__extensionValue {
...
typedef struct S1AP_LoggedMDT_ExtIEs {
	...
	struct S1AP_LoggedMDT_ExtIEs__extensionValue {
		...
		union S1AP_LoggedMDT_ExtIEs__S1AP_extensionValue_u {
			S1AP_BluetoothMeasurementConfiguration_t	 BluetoothMeasurementConfiguration;
			S1AP_WLANMeasurementConfiguration_t	 WLANMeasurementConfiguration;
			S1AP_LoggedMDTTrigger_t	 LoggedMDTTrigger;
			S1AP_SensorMeasurementConfiguration_t	 SensorMeasurementConfiguration;
		} choice;
...
typedef struct S1AP_LTE_NTN_TAI_Information_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_LTE_NTN_TAI_Information_ExtIEs__extensionValue {
...
typedef struct S1AP_RAT_RestrictionsItem_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_RAT_RestrictionsItem_ExtIEs__extensionValue {
...
typedef struct S1AP_SecurityResult_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_SecurityResult_ExtIEs__extensionValue {
...
typedef struct S1AP_SensorMeasConfigNameItem_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_SensorMeasConfigNameItem_ExtIEs__extensionValue {
...
typedef struct S1AP_SensorMeasurementConfiguration_ExtIEs {
	S1AP_ProtocolExtensionID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_SensorMeasurementConfiguration_ExtIEs__extensionValue {
...
typedef struct S1AP_TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs {
	...
	struct S1AP_TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs__extensionValue {
		...
		union S1AP_TargeteNB_ToSourceeNB_TransparentContainer_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_E_RABSecurityResultList_t	 E_RABSecurityResultList;
			S1AP_Direct_Forwarding_Path_Availability_t	 Direct_Forwarding_Path_Availability;
		} choice;
...
typedef struct S1AP_UserLocationInformation_ExtIEs {
	...
	struct S1AP_UserLocationInformation_ExtIEs__extensionValue {
		...
		union S1AP_UserLocationInformation_ExtIEs__S1AP_extensionValue_u {
			...
			S1AP_LTE_NTN_TAI_Information_t	 LTE_NTN_TAI_Information;
		} choice;
