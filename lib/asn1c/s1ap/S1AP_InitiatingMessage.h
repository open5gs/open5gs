...
typedef struct S1AP_InitiatingMessage__value {
	...
	union S1AP_InitiatingMessage__S1AP_value_u {
		...
		S1AP_UERadioCapabilityIDMappingRequest_t	 UERadioCapabilityIDMappingRequest;
		...
		S1AP_HandoverSuccess_t	 HandoverSuccess;
		S1AP_ENBEarlyStatusTransfer_t	 ENBEarlyStatusTransfer;
		S1AP_MMEEarlyStatusTransfer_t	 MMEEarlyStatusTransfer;
	} choice;
