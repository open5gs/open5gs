...
typedef struct S1AP_E_RABSecurityResultListIEs {
	S1AP_ProtocolIE_ID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_E_RABSecurityResultListIEs__value {
...
typedef struct S1AP_EventTrigger_ExtIEs {
	S1AP_ProtocolIE_ID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_EventTrigger_ExtIEs__value {
...
typedef struct S1AP_MeasurementThresholdL1LoggedMDT_ExtIEs {
	S1AP_ProtocolIE_ID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_MeasurementThresholdL1LoggedMDT_ExtIEs__value {
...
typedef struct S1AP_SensorNameConfig_ExtIEs {
	S1AP_ProtocolIE_ID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_SensorNameConfig_ExtIEs__value {
...
typedef struct S1AP_E_RABToBeUpdatedItemIEs {
	S1AP_ProtocolIE_ID_t	 id;
	S1AP_Criticality_t	 criticality;
	struct S1AP_E_RABToBeUpdatedItemIEs__value {
