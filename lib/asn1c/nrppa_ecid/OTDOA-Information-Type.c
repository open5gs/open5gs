...
asn_per_constraints_t asn_PER_type_OTDOA_Information_Type_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_OTDOA_Information_Type_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_ProtocolIE_Single_Container_102P48,
		0,
		{
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_OTDOA_Information_Type_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
