...
asn_TYPE_member_t asn_MBR_PathlossReferenceSignal_1[] = {
	{ ATF_POINTER, 0, offsetof(struct PathlossReferenceSignal, choice.sSB_Reference),
	...
	{ ATF_POINTER, 0, offsetof(struct PathlossReferenceSignal, choice.dL_PRS_Reference),
	...
	{ ATF_POINTER, 0, offsetof(struct PathlossReferenceSignal, choice.choice_Extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Single_Container_102P17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
