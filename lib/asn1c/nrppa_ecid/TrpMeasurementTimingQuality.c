...
asn_TYPE_member_t asn_MBR_TrpMeasurementTimingQuality_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TrpMeasurementTimingQuality, measurementQuality),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TrpMeasurementTimingQuality, resolution),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct TrpMeasurementTimingQuality, iE_extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_128P150,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_TrpMeasurementTimingQuality_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_TrpMeasurementTimingQuality_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TrpMeasurementTimingQuality_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_TrpMeasurementTimingQuality_specs_1 = {
	...
	asn_MAP_TrpMeasurementTimingQuality_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
