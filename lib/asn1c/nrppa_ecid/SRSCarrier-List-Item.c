...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_pCI_NR_constr_5 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SRSCarrier_List_Item_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SRSCarrier_List_Item, pCI_NR),
	...
	{ ATF_POINTER, 1, offsetof(struct SRSCarrier_List_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_128P121,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_SRSCarrier_List_Item_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pCI-NR */
