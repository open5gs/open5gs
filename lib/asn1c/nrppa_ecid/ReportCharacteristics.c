...
static const asn_INTEGER_enum_map_t asn_MAP_ReportCharacteristics_value2enum_1[] = {
	{ 0,	8,	"onDemand" },
	{ 1,	8,	"periodic" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_ReportCharacteristics_enum2value_1[] = {
	0,	/* onDemand(0) */
	1	/* periodic(1) */
	/* This list is extensible */
};
const asn_INTEGER_specifics_t asn_SPC_ReportCharacteristics_specs_1 = {
	asn_MAP_ReportCharacteristics_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_ReportCharacteristics_enum2value_1,	/* N => "tag"; sorted by N */
