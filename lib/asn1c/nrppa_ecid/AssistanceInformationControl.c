...
static asn_TYPE_member_t asn_MBR_AssistanceInformationControl_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AssistanceInformationControl, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Container_99P9,
		0,
		{
...
static const asn_TYPE_tag2member_t asn_MAP_AssistanceInformationControl_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* protocolIEs */
};
static asn_SEQUENCE_specifics_t asn_SPC_AssistanceInformationControl_specs_1 = {
