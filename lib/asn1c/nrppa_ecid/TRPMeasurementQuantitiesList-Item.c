...
asn_TYPE_member_t asn_MBR_TRPMeasurementQuantitiesList_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TRPMeasurementQuantitiesList_Item, tRPMeasurementQuantities_Item),
	...
	{ ATF_POINTER, 2, offsetof(struct TRPMeasurementQuantitiesList_Item, timingReportingGranularityFactor),
	...
	{ ATF_POINTER, 1, offsetof(struct TRPMeasurementQuantitiesList_Item, iE_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_128P148,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_TRPMeasurementQuantitiesList_Item_tag2el_1[] = {
