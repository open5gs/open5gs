...
#ifndef PWSIWF_SBI_PATH_H
#define PWSIWF_SBI_PATH_H
...
#define PWSIWF_NONUEN2_MESSAGE_TRANSFER_NO_STATE             0
#define PWSIWF_WARNING_MESSAGE_BROADCAST                     1
#define PWSIWF_WARNING_MESSAGE_STOP                          2
#define PWSIWF_WARNING_MESSAGE_UPDATE                        3
#define PWSIWF_WARNING_MESSAGE_CANCEL                        4
#define PWSIWF_WARNING_MESSAGE_RETRANSMISSION                5
#define PWSIWF_WARNING_MESSAGE_ERROR                         6
    int state;
