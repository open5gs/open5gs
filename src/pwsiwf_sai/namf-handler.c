        ...
        pwsiwf_sai_warning_t *warning, int state, ogs_sbi_message_t *recvmsg)
{
    ...
    switch (state) {
    case PWSIWF_SAI_WARNING_MESSAGE_BROADCAST:
    ...
    case PWSIWF_SAI_WARNING_MESSAGE_UPDATE:
    case PWSIWF_SAI_WARNING_MESSAGE_RETRANSMISSION:
        if (recvmsg->res_status == OGS_SBI_HTTP_STATUS_OK) {
    ...
    case PWSIWF_SAI_WARNING_MESSAGE_STOP:
    case PWSIWF_SAI_WARNING_MESSAGE_CANCEL:
    case PWSIWF_SAI_WARNING_MESSAGE_ERROR:
