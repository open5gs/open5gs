...
static void gtp_proxy_main(void *data);

static int initialized = 0;

int gtp_proxy_initialize(void)
{
    int rv;

#define APP_NAME "gtp-proxy"
    ...
    thread = ogs_thread_create(gtp_proxy_main, NULL);
