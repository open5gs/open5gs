...
extern int __gtp_proxy_log_domain;

#undef OGS_LOG_DOMAIN
#define OGS_LOG_DOMAIN __gtp_proxy_log_domain
...
typedef struct sgwc_context_s {
    ...
    ogs_sockaddr_t smf_addr;  /* Upstream address for CreateSession requests */

    ogs_sock_t *gtpc_backend_sock; /* GTP-C socket on the back-end IPv4 address */
    ogs_sock_t *gtpc_backend_sock6; /* GTP-C socket on the back-end IPv6 address */

    ogs_sockaddr_t *gtpc_backend_addr; /* Back-end IPv4 address */
    ogs_sockaddr_t *gtpc_backend_addr6; /* Back-end IPv6 address */
} sgwc_context_t;
